...
For more information about the command options, see [elasticsearch-setup-passwords](elasticsearch://docs/reference/elasticsearch/command-line-tools/setup-passwords.md).
...
See [Configuring credentials for {{ls}} monitoring](logstash://docs/reference/ingestion-tools/logstash/secure-connection.md#ls-monitoring-user).
...
For example, see [Monitoring {{metricbeat}}](beats://docs/reference/ingestion-tools/beats-metricbeat/monitoring.md).
