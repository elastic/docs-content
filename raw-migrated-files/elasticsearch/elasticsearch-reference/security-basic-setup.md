...
1. Open the `$ES_PATH_CONF/elasticsearch.yml` file and make the following changes:
    ...
    1. Add the [`cluster-name`](elasticsearch://docs/reference/elasticsearch/configuration-reference/miscellaneous-cluster-settings.md#cluster-name) setting and enter a name for your cluster:
