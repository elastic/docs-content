...
You can use any Cohere and OpenAI models, they are all supported by the {{infer}} API. For a list of recommended models available on HuggingFace, refer to [the supported model list](../../elastic-inference/inference-api/huggingface-inference-integration.md#inference-example-hugging-face-supported-models).
