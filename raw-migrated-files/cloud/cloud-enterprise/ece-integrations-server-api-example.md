...
It’s possible to enable Integrations Server on an existing deployment with version 8.0 only if [APM & Fleet Server](https://www.elastic.co/guide/en/cloud-enterprise/3.7/ece-manage-apm-and-fleet.html) hasn’t been previously enabled on the deployment.
