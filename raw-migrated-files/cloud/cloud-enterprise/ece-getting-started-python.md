...
For frequently used API calls with the Python client, check [Examples](elasticsearch-py://docs/reference/elasticsearch/elasticsearch-client-python-api/examples.md).
...
For more information on refreshing an index, searching, updating, and deleting, check the [elasticsearch-py examples](elasticsearch-py://docs/reference/elasticsearch/elasticsearch-client-python-api/examples.md).
