...
`region`
:   The region is always the same region as the deployment you want to associate with a traffic filter rule set. For details, check the [list of available regions](cloud://docs/reference/cloud/cloud-hosted/ec-regions-templates-instances.md).
