...
Knowing how to scale your deployment is critical, especially when unexpected workloads hits. Don’t forget to [check your performance metrics](/deploy-manage/monitor/ec-saas-metrics-accessing.md) to make sure your deployments are healthy and can cope with your workloads.
