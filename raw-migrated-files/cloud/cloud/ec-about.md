...
* [Elasticsearch Service Hardware](cloud://docs/reference/cloud/cloud-hosted/hardware.md)
* [Elasticsearch Service Regions](cloud://docs/reference/cloud/cloud-hosted/regions.md)
