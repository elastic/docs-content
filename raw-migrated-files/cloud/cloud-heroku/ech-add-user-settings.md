...
:   Configures [Slack notification settings](/explore-analyze/alerts-cases/watcher/actions-slack.md#actions-slack). Note that you need to add `secure_url` as a [secret value to the keystore](../../../deploy-manage/security/secure-settings.md).
