...
3. Specify the {{kib}} server CA certificate chain in `elasticsearch.yml`:
    ...
    For more information, see [the {{watcher}} HTTP TLS/SSL Settings](elasticsearch://docs/reference/elasticsearch/configuration-reference/watcher-settings.md#ssl-notification-settings).
