...
**Console** lets you interact with [{{es}} APIs](elasticsearch://docs/reference/elasticsearch/rest-apis/index.md) and [{{kib}} APIs](https://www.elastic.co/docs/api) from within {{kib}}.
