...
| [Logstash Pipelines](logstash://docs/reference/ingestion-tools/logstash/logstash-centralized-pipeline-management.md) | Create, edit, and delete your Logstash pipeline configurations. |
...
| [Advanced Settings](kibana://docs/reference/advanced-settings.md) | Customize {{kib}} to suit your needs. Change the format for displaying dates, turn on dark mode,set the timespan for notification messages, and much more. |
