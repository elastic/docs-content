...
2. To install and configure one or more APM agents, do one of following:
    ...
    * Use the following instructions:
        ...
        * [Configuration](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/configuration.md)
        ...
        Django and Flask are two of several frameworks that the Elastic APM Python Agent supports. For a complete list of supported technologies, refer to the [Elastic APM Python Agent documentation](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/supported-technologies.md).
