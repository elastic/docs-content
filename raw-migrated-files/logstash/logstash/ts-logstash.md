...
* Use the [bundled JDK](logstash://docs/reference/ingestion-tools/logstash/getting-started-with-logstash.md#ls-jvm) included with Logstash
...
See the [troubleshooting information](logstash://docs/reference/ingestion-tools/logstash/persistent-queues.md#troubleshooting-pqs) in the persistent queue section for more information on remediating problems with persistent queues.
...
For general performance tuning tips and guidelines, see [*Performance tuning*](logstash://docs/reference/ingestion-tools/logstash/performance-tuning.md).
