...
```
:::{tip}
For versions 9.2.0 and later, {{agent}} includes out-of-the-box alert rules for most common health checks. Check out [Elastic Agent built-in alerts](/reference/fleet/alert-templates.md). 
:::
