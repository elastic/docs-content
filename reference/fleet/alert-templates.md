...
| [Elastic Agent] Offline status | Desc <br> - Condition:  <br>- Default: Disabled|
...
| [Elastic Agent] Unenrolled status | removed from Fleet, API keys revoked, no data flow, re-enrollment required <br> - Condition:  <br>- Default: Disabled|
...
| [Elastic Agent] Uninstalled status | Desc <br> - Condition:  <br>- Default: Disabled|
