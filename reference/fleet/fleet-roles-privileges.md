...
Change the agents access to `All` to enable the role to perform the [full set of available actions](#manage-agents) on {{agents}}.
...
| --- | --- | --- |
| Agents | View-only access to {{agents}}, including:<br><br>* [View a list of all agents and their status](#view-agent-status)<br>* [Request agent diagnostic packages](#collect-agent-diagnostics) |Full access to manage {{agents}}, including:<br><br>* [Perform upgrades](#upgrade-elastic-agent)<br>* [Configure monitoring](monitor-elastic-agent)<br>* [Migrate agents to a new cluster](migrate-elastic-agent)<br>* [Unenroll agents from {{fleet}}](unenroll-elastic-agent)<br>* [Set the inactivity timeout](set-inactivity-timeout)<br>* [Create and revoke enrollment tokens](fleet-enrollment-tokens) |
| Agent policies | View-only access, including:<br><br>* Agent policies and settings<br>* The integrations associated with a policy | Full access to manage agent policies, including:<br><br>* [Create a policy](create-a-policy)<br>* [Add an integration to a policy](add-integration)<br>* [Apply a policy](apply-a-policy)<br>* [Edit or delete an integration](policy-edit-or-delete)<br>* [Copy a policy](copy-policy)<br>* [Edit or delete a policy](policy-main-settings)<br>* [Change the output of a policy](change-policy-output) |
| Fleet settings | View-only access, including:<br><br>* Configured {{fleet}} hosts<br>* {{fleet}} output settings<br>* The location to download agent binaries | Full access to manage {{fleet}} settings, including:<br><br>* [Editing hosts](fleet-server-hosts-setting)<br>* [Adding or editing outputs](output-settings)<br>* [Update the location for downloading agent binaries](fleet-agent-binary-download-settings) |
