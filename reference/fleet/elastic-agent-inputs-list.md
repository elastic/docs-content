...
| `audit/system` | [beta] Collects various security related information about a system. All datasets send both periodic state information (for example all currently running processes) and real-time changes (for example when a new process starts or stops). | [System Module](beats://reference/auditbeat/auditbeat-module-system.md) ({{auditbeat}} docs) |
