...
By default, the {{product.edot-collector}} uses one of several predefined host metrics configurations based on the `hostmetrics` receiver. Refer to [](elastic-agent://reference/edot-collector/config/default-config-standalone.md).
