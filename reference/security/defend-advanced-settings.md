...
`windows.advanced.events.image_load.enable_origin_info_collection`
:   Added in 8.19.0.
...
`windows.advanced.events.process.enable_origin_info_collection`
:   Added in 8.19.0.
...
`windows.advanced.events.file.enable_origin_info_collection`
:   Added in 8.19.0.
