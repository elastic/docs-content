...
1. Find **Policies** in the navigation menu or by using the [global search field](docs-content://get-started/the-stack.md#kibana-navigation-search), then select the integration policy you want to configure.
