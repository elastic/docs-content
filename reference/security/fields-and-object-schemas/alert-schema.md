...
| `kibana.alert.url` | The shareable URL for the alert.<br>**Note:** This field appears only if you’ve set the [`server.publicBaseUrl`](kibana://reference/configuration-reference/general-settings.md) configuration setting in the [`kibana.yml`](/deploy-manage/stack-settings.md) file.<br>Type: long |
