...
* [{{agent}} input plugin](asciidocalypse://docs/logstash/docs/reference/plugins-inputs-elastic_agent.md)
* [{{es}} output plugin](asciidocalypse://docs/logstash/docs/reference/plugins-outputs-elasticsearch.md)
* [Secure your connection to {{es}}](asciidocalypse://docs/logstash/docs/reference/secure-connection.md)
