...
For more information about configuring {{ls}}, refer to [Configuring {{ls}}](asciidocalypse://docs/logstash/docs/reference/creating-logstash-pipeline.md) and [{{agent}} input plugin](asciidocalypse://docs/logstash/docs/reference/plugins-inputs-elastic_agent.md).
...
::::{note}
To use SSL/TLS, you must also configure the [{{agent}} input plugin for {{ls}}](asciidocalypse://docs/logstash/docs/reference/plugins-inputs-beats.md) to use SSL/TLS.
::::
