...
- (**Active** rules only) **Mark as acknowledged**: Set the alert to [**acknowledged**](https://www.elastic.co/docs/explore-analyze/alerting/alerts/view-alerts#acknowledge-alerts) {applies_to}`stack: 9.4+`
