...
| `rowCount` | `number` | The number of empty rows to add to the table, to be assigned a value later.<br>{applies_to}`stack: ga 9.3` {applies_to}`serverless: ga` Must be an integer between 0 and 10,000.<br>Default: `1` |
