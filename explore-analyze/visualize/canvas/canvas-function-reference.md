...
| `format` | `string` | The MomentJS format used to parse the specified date string. For more information, see [Moment.js format documentation](https://momentjs.com/docs/#/displaying/format/). |
...
Formats an ISO8601 date string or a date in milliseconds since epoch using MomentJS. See [Moment.js format documentation](https://momentjs.com/docs/#/displaying/format/).
...
| Argument | Type | Description |
| --- | --- | --- |
| *Unnamed* **\***<br>Alias: `format` | `string` | A MomentJS format. For example, `"MM/DD/YYYY"`. See [Moment.js format documentation](https://momentjs.com/docs/#/displaying/format/). |
...
| `flags`<br>Alias: `modifiers` | `string` | Specify flags. See [the RegExp reference on MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp).<br>Default: `"g"` |
...
| Argument | Type | Description |
| --- | --- | --- |
| *Unnamed*<br>Alias: `format` | `string` | The MomentJS format to use for bucketing. For example, `"YYYY-MM"` rounds to months. See [Moment.js format documentation](https://momentjs.com/docs/#/displaying/format/). |
...
| `timezone` | `string` | The timezone for the time range. See [Moment.js timezone documentation](https://momentjs.com/timezone/).<br>Default: `"UTC"` |
