...
* [Fleet](docs-content://docs/reference/ingestion-tools/fleet/index.md) is enabled on your cluster, and one or more [{{agent}}s](docs-content://docs/reference/ingestion-tools/fleet/install-elastic-agents.md) is enrolled.
...
The **TriMet Alerts connector** is added to the **{{connectors-ui}}** page. For more information on common connectors, refer to the [Slack](kibana://docs/reference/connectors-kibana/slack-action-type.md) and [Email](kibana://docs/reference/connectors-kibana/email-action-type.md) connectors.
