...
Add [_index](elasticsearch://docs/reference/elasticsearch/mapping-reference/mapping-index-field.md) to your search to include documents from indices that do not contain a search field.
