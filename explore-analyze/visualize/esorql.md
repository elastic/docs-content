...
You can add {{esql}} visualizations to a dashboard directly from queries in Discover, or you can start from a dashboard. For guidance on choosing between the {{esql}} mode and the point-and-click mode, refer to [Choose your visualization approach](lens.md#visualization-approach).
