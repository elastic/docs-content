...
1. To set up Metricbeat, go to [Metricbeat quick start: installation and configuration](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-installation-configuration.md)
2. Go to **Dashboards**.
