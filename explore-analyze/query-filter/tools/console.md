...
**Console** is an interactive UI for sending requests to [{{es}} APIs](elasticsearch://docs/reference/elasticsearch/rest-apis/index.md) and [{{kib}} APIs](https://www.elastic.co/docs/api) and viewing their responses.
