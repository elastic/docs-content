...
| [{{alerting-v2-system-cap}}](/explore-analyze/alerting/esql/system-overview.md) | Build and preview rules with separate base, alert, and recovery queries | Task-specific editor and YAML editor |
