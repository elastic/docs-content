...
The {{es}} notation for enumerating, including or excluding [multi-target syntax](elasticsearch://docs/reference/elasticsearch/rest-apis/api-conventions.md#api-multi-index) is supported *as long* as it is quoted or escaped as a table identifier.
