...
A `_remote` enrich cannot be executed after a [stats](elasticsearch://reference/query-languages/esql/_snippets/commands/layout/stats-by.md) command. The following example would result in an error:
