...
**Leaf query clauses**: Leaf query clauses look for a particular value in a particular field, such as the [`match`](elasticsearch://docs/reference/query-languages/query-dsl-match-query.md), [`term`](elasticsearch://docs/reference/query-languages/query-dsl-term-query.md) or [`range`](elasticsearch://docs/reference/query-languages/query-dsl-range-query.md) queries. These queries can be used by themselves.

**Compound query clauses**: Compound query clauses wrap other leaf **or** compound queries and are used to combine multiple queries in a logical fashion (such as the [`bool`](elasticsearch://docs/reference/query-languages/query-dsl-bool-query.md) or [`dis_max`](elasticsearch://docs/reference/query-languages/query-dsl-dis-max-query.md) query), or to alter their behavior (such as the [`constant_score`](elasticsearch://docs/reference/query-languages/query-dsl-constant-score-query.md) query).
...
**Allow expensive queries**: Certain types of queries will generally execute slowly due to the way they are implemented, which can affect the stability of the cluster. Those queries can be categorized as follows:
  ...
  - Queries that need to do linear scans to identify matches:
    ...
    - [`script` queries](elasticsearch://docs/reference/query-languages/query-dsl-script-query.md)
    - queries on [numeric](elasticsearch://docs/reference/elasticsearch/mapping-reference/number.md), [date](elasticsearch://docs/reference/elasticsearch/mapping-reference/date.md), [boolean](elasticsearch://docs/reference/elasticsearch/mapping-reference/boolean.md), [ip](elasticsearch://docs/reference/elasticsearch/mapping-reference/ip.md), [geo_point](elasticsearch://docs/reference/elasticsearch/mapping-reference/geo-point.md) or [keyword](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md) fields that are not indexed but have [doc values](elasticsearch://docs/reference/elasticsearch/mapping-reference/doc-values.md) enabled

  - Queries that have a high up-front cost:

    - [`fuzzy` queries](elasticsearch://docs/reference/query-languages/query-dsl-fuzzy-query.md) (except on [`wildcard`](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md#wildcard-field-type) fields)
    - [`regexp` queries](elasticsearch://docs/reference/query-languages/query-dsl-regexp-query.md) (except on [`wildcard`](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md#wildcard-field-type) fields)
    - [`prefix` queries](elasticsearch://docs/reference/query-languages/query-dsl-prefix-query.md)  (except on [`wildcard`](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md#wildcard-field-type) fields or those without [`index_prefixes`](elasticsearch://docs/reference/elasticsearch/mapping-reference/index-prefixes.md))
    - [`wildcard` queries](elasticsearch://docs/reference/query-languages/query-dsl-wildcard-query.md) (except on [`wildcard`](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md#wildcard-field-type) fields)
    - [`range` queries](elasticsearch://docs/reference/query-languages/query-dsl-range-query.md) on [`text`](elasticsearch://docs/reference/elasticsearch/mapping-reference/text.md) and [`keyword`](elasticsearch://docs/reference/elasticsearch/mapping-reference/keyword.md) fields

  - [Joining queries](elasticsearch://docs/reference/query-languages/joining-queries.md)
  - Queries that may have a high per-document cost:

    - [`script_score` queries](elasticsearch://docs/reference/query-languages/query-dsl-script-score-query.md)
    - [`percolate` queries](elasticsearch://docs/reference/query-languages/query-dsl-percolate-query.md)
...
* `filter` or `must_not` parameters in [`bool`](elasticsearch://docs/reference/query-languages/query-dsl-bool-query.md)  queries
* `filter` parameter in [`constant_score`](elasticsearch://docs/reference/query-languages/query-dsl-constant-score-query.md) queries
* [`filter`](elasticsearch://docs/reference/data-analysis/aggregations/search-aggregations-bucket-filter-aggregation.md) aggregations
