...
In many cases, attackers use malicious scripts to connect to remote servers or download other files. Use an [EQL sequence query](elasticsearch://docs/reference/query-languages/eql-syntax.md#eql-sequences) to check for the following series of events:
