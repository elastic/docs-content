...
::::{note} 
`FIRST` cannot be used with columns of type [`text`](asciidocalypse://docs/elasticsearch/docs/reference/elasticsearch/mapping-reference/text.md) unless the field is also [saved as a keyword](https://www.elastic.co/guide/en/elasticsearch/reference/current/text.html#before-enabling-fielddata).
::::
