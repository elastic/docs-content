...
The ES|QL editor supports [`LOOKUP JOIN`](elasticsearch://reference/query-languages/esql/_snippets/commands/layout/lookup-join.md) commands and suggests lookup mode indices and join condition fields.
