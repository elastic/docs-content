...
::::{tip}
Pattern detection on text fields is also available outside {{esql}} from **Patterns** in Discover's classic mode. Refer to [](/explore-analyze/discover/run-pattern-analysis-discover.md).
::::
