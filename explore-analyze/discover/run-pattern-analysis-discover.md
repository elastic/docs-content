...
products:
  - id: kibana
description: Detect patterns in unstructured logs with pattern analysis in Discover. Categorize log messages, identify common structures, and filter noise during troubleshooting.
---
