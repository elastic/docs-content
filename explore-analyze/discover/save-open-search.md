...
- {applies_to}`serverless: ga` {applies_to}`stack: ga 9.6+` **View mode** and the JSON display settings for the document table. Refer to [View documents as JSON](document-explorer.md#document-explorer-view-mode).
