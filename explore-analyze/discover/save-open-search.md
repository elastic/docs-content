...
- [The visualization](#add-discover-visualization-to-dashboard): the chart generated by your query.
- [The data table](#save-table-to-dashboard): the table with your query results.
...
A full Discover session panel retains the session's tabs, columns, sort order, and other settings, and can display a single tab as a data table.
