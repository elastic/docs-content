...
- [The visualization](#add-discover-visualization-to-dashboard) — the Lens chart generated by your query
- [The data table](#save-table-to-dashboard) — the documents grid with your query results
- [The entire Discover session](#add-full-discover-session-to-dashboard) — a panel that preserves your query, filters, columns, and sort order
