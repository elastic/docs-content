...
This example uses the [get agent consumption data API]({{kib-apis}}operation/operation-post-agent-builder-agents-agent-id-consumption) with default pagination.
