...
:::{note}
This guide explains how to call an **agent from a workflow**. If you want to trigger a **workflow from an agent's chat interface**, refer to the [Workflow tools](./tools/workflow-tools.md) reference.
:::
