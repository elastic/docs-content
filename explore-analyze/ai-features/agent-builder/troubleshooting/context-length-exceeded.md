...
- **Add index metadata descriptions**: Help agents select more appropriate indices by adding [`_meta.description` fields](../tools/index-search-tools.md#improve-index-selection-with-metadata) to your index mappings.
