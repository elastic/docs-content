...
:::{note}
This page explains how to trigger an existing workflow in an agent conversation. To create a new workflow from Agent Chat, refer to [Create skills and workflows in chat](../chat.md#create-skills-and-workflows-directly-from-chat). To create or edit workflows with natural language in the **Workflows** app, refer to [Author workflows with natural language](/explore-analyze/workflows/authoring-techniques/use-natural-language.md). If you want to use an agent within a workflow step, refer to [Call agents from workflows](../agents-and-workflows.md).
:::
