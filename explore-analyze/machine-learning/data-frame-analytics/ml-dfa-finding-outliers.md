...
2. Create a {{transform}} that generates an entity-centric index with numeric or boolean data to analyze.
   ...
   You can preview the {{transform}} before you create it in the **Transforms** page, which you can find in the main menu or by using the [global search field](../../find-and-organize/find-apps-and-objects.md) in {{kib}}.:
