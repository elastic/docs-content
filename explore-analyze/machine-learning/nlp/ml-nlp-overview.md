...
You can **store embeddings in your {{es}} vector database** if you generate [dense vector](elasticsearch://docs/reference/elasticsearch/mapping-reference/dense-vector.md) or [sparse vector](elasticsearch://docs/reference/elasticsearch/mapping-reference/sparse-vector.md) model embeddings outside of {{es}}.
