...
2. Add an [{{infer}} processor](elasticsearch://docs/reference/ingestion-tools/enrich-processor/inference-processor.md) to your pipeline:
    ...
    3. If you use the {{lang-ident}} model (`lang_ident_model_1`) that is provided in your cluster:
        ...
        2. You can also optionally add [classification configuration options](elasticsearch://docs/reference/ingestion-tools/enrich-processor/inference-processor.md#inference-processor-classification-opt) in the **{{infer-cap}} configuration** section. For example, to include the top five language predictions:
...
3. Optional: Add a [set processor](elasticsearch://docs/reference/ingestion-tools/enrich-processor/set-processor.md) to index the ingest timestamp.
...
::::{tip}
To use the `annotated_text` data type in this example, you must install the [mapper annotated text plugin](elasticsearch://docs/reference/elasticsearch-plugins/mapper-annotated-text.md). For more installation details, refer to [Add plugins provided with {{ech}}](elasticsearch://docs/reference/elasticsearch-plugins/cloud/ec-adding-elastic-plugins.md).
::::
