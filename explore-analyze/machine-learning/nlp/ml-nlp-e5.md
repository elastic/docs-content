...
You can also download and deploy the E5 model either from the **Trained models** page, from **Search** > **Indices**, or by using the trained models API in Dev Console.
