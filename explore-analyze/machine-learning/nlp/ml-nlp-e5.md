...
You can also download and deploy the E5 model either from **{{stack-manage-app}} > {{ml-app}} > Trained models** in the main menu, **{{ml-app}}** > **Trained Models**, from **Search** > **Indices**, or by using the trained models API in Dev Console.
...
6. Navigate to the **Trained Models** page from the main menu (**{{stack-manage-app}} > {{ml-app}} > Trained models**), or use the [global search field](../../find-and-organize/find-apps-and-objects.md) in {{kib}}. E5 can be found in the list of trained models.
