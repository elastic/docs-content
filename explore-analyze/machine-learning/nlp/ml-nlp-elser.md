...
Elastic Learned Sparse EncodeR - or ELSER - is a retrieval model trained by Elastic that enables you to perform [semantic search](/solutions/search/vector/semantic-search-elser.md) to retrieve more relevant search results. This search type provides you search results based on contextual meaning and user intent, rather than exact keyword matches.
...
* [Perform semantic search with ELSER](/solutions/search/vector/semantic-search-elser.md)
