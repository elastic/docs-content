...
8. Navigate to the **Trained Models** page from the main menu (**{{stack-manage-app}} > {{ml-app}} > Trained models**), or use the [global search field](../../find-and-organize/find-apps-and-objects.md) in {{kib}}. ELSER can be found in the list of trained models.
...
6. Navigate to the **Trained Models** page from the main menu (**{{stack-manage-app}} > {{ml-app}} > Trained models**), or use the [global search field](../../find-and-organize/find-apps-and-objects.md) in {{kib}}. ELSER can be found in the list of trained models.
...
You can test the deployed model in {{kib}}. Navigate to the **Trained Models** page from the main menu (**{{stack-manage-app}} > {{ml-app}} > Trained models**), or use the [global search field](../../find-and-organize/find-apps-and-objects.md) in {{kib}}. Locate the deployed ELSER model in the list of trained models, then select **Test model** from the Actions menu.
