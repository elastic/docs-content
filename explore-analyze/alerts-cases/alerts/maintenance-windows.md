...
In **Management > {{stack-manage-app}} > Maintenance Windows** or **{{project-settings}} > {{manage-app}} > {{maint-windows-app}}** in Serverless, you can create, edit, and archive maintenance windows. In {{stack}} 9.1.0 and later, you can also delete maintenance windows that are running, canceled, or canceled and archived. Be aware that you can't recover maintenance windows once you delete them.
