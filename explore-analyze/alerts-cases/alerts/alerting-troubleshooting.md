...
If cluster performance becomes degraded from excessive or expensive rules and {{kib}} is sluggish or unresponsive, you can temporarily reduce load to the Task Manager by updating its [settings](kibana://docs/reference/configuration-reference/task-manager-settings.md):
