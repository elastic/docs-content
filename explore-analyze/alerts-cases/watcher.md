...
Make sure your snapshots include the `watcher` feature state. By default, snapshots include all feature states, unless explicitly configured otherwise. For more information, refer to [feature states](/deploy-manage/tools/snapshot-and-restore.md#feature-states) in the snapshots documentation.
