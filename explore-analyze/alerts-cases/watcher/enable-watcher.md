...
For a full reference of all available settings, see the [Elasticsearch documentation](elasticsearch://docs/reference/elasticsearch/configuration-reference/watcher-settings.md#email-notification-settings).
