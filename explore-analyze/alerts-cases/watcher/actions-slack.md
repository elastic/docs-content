...
You can specify defaults for the [Slack notification attributes](elasticsearch://docs/reference/elasticsearch/configuration-reference/watcher-settings.md#slack-account-attributes):
