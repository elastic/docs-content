...
For the most reliable configuration of PDF/PNG {{report-features}}, consider installing {{kib}} using [Docker](../../deploy-manage/deploy/self-managed/install-kibana-with-docker.md) or using [{{ecloud}}](https://cloud.elastic.co?page=docs&placement=docs-body).
