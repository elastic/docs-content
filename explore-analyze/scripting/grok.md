...
The ECS pattern set has all of the pattern definitions from the legacy set, and is a drop-in replacement. Use the [`ecs-compatability`](logstash://docs/reference/ingestion-tools/logstash/plugins-filters-grok.md#plugins-filters-grok-ecs_compatibility) setting to switch modes.
