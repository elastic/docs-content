...
2. Change the **Minimum interval** to **1d**, then click **Close**.
    ...
    You can increase and decrease the minimum interval, but you are unable to decrease the interval below the configured [**Advanced Settings**](kibana://docs/reference/advanced-settings.md).
