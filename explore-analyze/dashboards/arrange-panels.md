...
Organize your dashboard panels into sections that users can collapse or expand when viewing it. Collapsible sections also help dashboards load faster by only loading the content from expanded sections.
...
4. Move any panels you want into the section by dragging and dropping them.
   ...
   :::
5. Just like any other panel, you can move the collapsible section to a different position in the dashboard using drag and drop.
