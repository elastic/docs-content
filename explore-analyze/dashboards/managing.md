...
{applies_to}`stack: preview 9.5` For per-user records of dashboard creation, updates, deletion, views, and refreshes, configure [Kibana user activity logging](kibana://reference/user-activity.md#event-fields).
