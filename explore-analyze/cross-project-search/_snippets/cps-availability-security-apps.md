...
<!-- TODO: After https://github.com/elastic/docs-content/pull/7814 merges, restore the link on "read data from linked projects" to /explore-analyze/machine-learning/anomaly-detection/ml-ad-run-jobs.md#ml-ad-cps-scope. -->
