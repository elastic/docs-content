...
The scope selector is not editable in every app. Some apps display it as read-only, and others show it as disabled. Refer to [{{cps-cap}} availability by app](#cps-availability) for details.
