...
All models on EIS incur a charge per million tokens. Certain LLM chat models charge different prices depending on the prompt size. The pricing details are available on our [Pricing page](https://www.elastic.co/pricing/serverless-search).
