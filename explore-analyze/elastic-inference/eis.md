...
You can use the `jina-embeddings-v3` model through the Elastic {{infer-cap}} Service. Running the model on EIS means that you use the model on GPUs, without the need of managing infrastrucuture and model resources.
