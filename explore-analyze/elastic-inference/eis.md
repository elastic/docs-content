...
- Delete endpoints
- {applies_to}`stack: ga 9.5` {applies_to}`serverless: ga` [Manage region preferences](eis-region-and-hosting.md#inference-region-preferences) for where EIS processes {{infer}} requests
