...
* [Advanced settings](kibana://docs/reference/advanced-settings.md)
...
The display of these patterns is affected by the [advanced setting](kibana://docs/reference/advanced-settings.md#kibana-general-settings) `format:number:defaultLocale`. The default locale is `en`, but some examples will specify that they are using an alternate locale.
