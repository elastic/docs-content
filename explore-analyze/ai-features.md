...
```
Elastic 9.2.0+ and Serverless deployments provide an [Agent Builder MCP server endpoint](/solutions/search/agent-builder/mcp-server.md) that exposes all built-in and custom [tools](/solutions/search/agent-builder/tools.md) you can use to power agentic workflows.
