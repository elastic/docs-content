...
:::{tip}
New to {{kib}}? **[Learn data exploration and visualization](learn-kibana-data-exploration.md)** walks you through {{kib}}'s core analyst features — Discover, Lens, and Dashboards — using your own system logs and {{esql}}.
:::
