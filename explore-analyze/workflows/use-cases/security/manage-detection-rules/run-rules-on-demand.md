...
- [Manage detection rules](/solutions/security/detect-and-alert/manage-detection-rules.md): The UI surface this workflow automates (see the "Run rules manually" section for the interactive equivalent).
