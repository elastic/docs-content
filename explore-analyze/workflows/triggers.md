...
* Auditing rule management actions, syncing rule inventory with external systems, or notifying a channel when rules change in {{alerting-v2-system}} {applies_to}`stack: experimental 9.5+` {applies_to}`serverless: ga`
