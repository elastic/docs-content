...
- [Rule event data model](alerts/alert-data-model.md): Understand how alert episodes and signals share `.rule-events`, which fields they have in common, and which fields are alert-only.
