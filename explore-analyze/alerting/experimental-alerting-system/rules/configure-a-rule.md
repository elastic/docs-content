...
| --- | --- | --- |
| [Rule mode](configure-rule-mode.md) | Controls whether matching rows are grouped into an alert episode or remain available for later analysis. Labeled **Mode** on 9.5, and **Outcome** from 9.6. | Required |
