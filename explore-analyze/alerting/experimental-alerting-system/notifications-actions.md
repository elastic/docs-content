...
{{rules-ui}} in the {{alerting-v2-system}} don't send notifications directly. Action policies and workflows notify for alert episodes. Signals skip action policy evaluation and workflow invocation. For an explanation of how action policies and workflows connect at runtime, refer to [Connect workflows](workflows-alerting.md).
