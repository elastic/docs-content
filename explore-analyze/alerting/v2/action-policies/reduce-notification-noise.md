...
products:
  - id: kibana
description: "How to reduce notification noise using acknowledge, snooze, and deactivate to silence alert episodes."
---
...
Several mechanisms can silence notifications for an alert episode. When an alert episode is silenced, the dispatcher stops processing it before any action policy matching, grouping, or frequency evaluation runs.
