...
products:
  - id: kibana
description: "Configure an Elasticsearch query rule in Kibana alerting v1 using DSL, ES|QL, KQL, or Lucene to detect conditions and trigger actions."
---

# Elasticsearch query rule [rule-type-es-query-v1]
