...
products:
  - id: kibana
description: "Create, edit, enable, disable, and manage Kibana alerting v1 rules from the Stack Management rules UI."
---

# Create and manage Kibana alerting v1 rules [create-and-manage-rules-v1]
