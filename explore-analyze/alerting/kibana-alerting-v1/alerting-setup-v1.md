...
You can generate a new API key at any time in **{{stack-manage-app}} > {{rules-ui-v1}}** or in the rule details page by selecting **Update API key** in the actions menu.
