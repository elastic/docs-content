...
products:
  ...
  - id: cloud-kubernetes
  - id: elastic-stack
description: "Get started with Kibana alerting v1 — create rules, define conditions, and trigger actions across Observability, Security, Maps, and Machine Learning."
---

# Get started with Kibana alerting v1 [alerting-getting-started-v1]
