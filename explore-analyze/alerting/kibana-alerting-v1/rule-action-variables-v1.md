---
navigation_title: Rule action variables
mapped_pages:
...
products:
  - id: kibana
description: "Reference of Mustache template variables available in Kibana alerting v1 rule actions, organized by rule type."
---

# Kibana alerting v1 rule action variables [rule-action-variables-v1]
