...
products:
  - id: kibana
description: "Configure a tracking containment rule in Kibana alerting v1 to alert when entities enter or leave geographic boundaries."
---

# Tracking containment rule (Kibana alerting v1) [geo-alerting-v1]
