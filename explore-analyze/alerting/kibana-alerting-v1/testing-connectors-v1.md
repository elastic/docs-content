---
navigation_title: Test connectors
mapped_pages:
...
products:
  - id: kibana
description: "Test Kibana alerting v1 connectors to verify they send notifications correctly before using them in rules."
---

# Test connectors in Kibana alerting v1 [testing-connectors-v1]
