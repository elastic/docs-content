---
navigation_title: Notification domain allowlist
mapped_pages:
...
products:
  - id: cloud-hosted
description: "Configure the notifications domain allowlist to restrict which recipient domains can receive Kibana alerting v1 email notifications."
---

# Kibana alerting v1 notifications domain allowlist [organizations-notifications-domain-allowlist-v1]
