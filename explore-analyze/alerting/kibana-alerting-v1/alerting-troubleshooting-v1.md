...
products:
  - id: kibana
description: "Troubleshoot Kibana alerting v1 rules and connectors — check logs, inspect task states, and understand known limitations."
---

# Kibana alerting v1 troubleshooting and limitations [alerting-troubleshooting-v1]
