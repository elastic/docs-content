---
navigation_title: Event log index
mapped_pages:
...
products:
  - id: kibana
description: "Query the Kibana alerting v1 event log index to diagnose rule execution, action failures, and run durations."
---

# Kibana alerting v1 event log index [event-log-index-v1]
