...
products:
  - id: kibana
description: "Configure an index threshold rule in Kibana alerting v1 to aggregate field values and trigger actions when thresholds are met."
---

# Index threshold rule [rule-type-index-threshold-v1]
