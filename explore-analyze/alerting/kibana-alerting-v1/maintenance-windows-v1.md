...
products:
  - id: kibana
  - id: cloud-serverless
description: "Schedule maintenance windows in Kibana alerting v1 to temporarily suppress rule notifications during planned outages."
---

# Kibana alerting v1 maintenance windows [maintenance-windows-v1]
