...
Elastic offers three alerting systems, each suited to different use cases and workflows. Don't use the {{alerting-v2-system}} in production. For production, use {{kib}} alerting. Use this page to compare them by goal, feature, and availability.
