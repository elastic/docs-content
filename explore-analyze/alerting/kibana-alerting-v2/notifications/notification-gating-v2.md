...
# Notification gating [notification-gating-v2]

$$$notification-gating-v2$$$
...
## How gating fits in the dispatcher [gating-in-dispatcher-v2]

$$$gating-in-dispatcher-v2$$$
...
## Gating mechanisms [gating-mechanisms-v2]

$$$gating-mechanisms-v2$$$
...
For instructions on snoozing and unsnoozing single or multiple episodes, refer to [View and manage alerts](../alerts/view-and-manage-alerts-v2.md#snooze-episode-v2).

## Related pages

- **[View and manage alerts](../alerts/view-and-manage-alerts-v2.md):** Apply gating actions (acknowledge, snooze, deactivate) from the alerts table or episode detail page.
- **[Notifications](../notifications-v2.md):** Set up action policies that control routing, grouping, and throttle after gating.
- **[{{alerting-v2}} alerts](../alerts-v2.md):** Understand alert episode lifecycle, series, and where alert data is stored.
