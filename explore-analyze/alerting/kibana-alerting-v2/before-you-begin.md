...
products:
  - id: kibana
  - id: cloud-serverless
description: Concept overview, access requirements, and setup to complete before authoring {{alerting-v2}} rules.
---

# Before you begin with {{alerting-v2}} [alerting-before-you-begin-v2]

These pages cover what to understand and configure before you create {{alerting-v2}} rules. Unlike [Author rules](author-rules.md), which focuses on building and changing rules, the topics below prepare your environment and permissions.
