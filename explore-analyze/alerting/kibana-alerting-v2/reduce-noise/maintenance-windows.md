...
products:
  - id: kibana
description: "Schedule periods during which {{alerting-v2}} notifications are paused for planned deployments or recurring maintenance."
---

# {{alerting-v2}} maintenance windows [maintenance-windows-v2]
