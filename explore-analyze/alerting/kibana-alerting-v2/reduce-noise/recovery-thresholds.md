...
products:
  - id: kibana
description: "Require sustained recovery before a {{alerting-v2}} alert episode returns to inactive, preventing rapid toggling between active and recovered."
---

# {{alerting-v2}} recovery thresholds [recovery-thresholds-v2]
