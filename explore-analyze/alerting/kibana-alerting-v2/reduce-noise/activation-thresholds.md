...
products:
  - id: kibana
description: "Require consecutive breaches or a minimum duration before a {{alerting-v2}} alert episode becomes active, filtering out transient spikes."
---

# {{alerting-v2}} activation thresholds [activation-thresholds-v2]
