...
products:
  - id: kibana
description: "Replace many individual {{alerting-v2}} notifications with a single meaningful one using rules that correlate across alert event data."
---

# {{alerting-v2}} rules on alerts [reduce-noise-rules-on-alerts-v2]
