...
products:
  - id: kibana
description: "Stop lifecycle processing and notifications for a {{alerting-v2}} alert episode while the rule continues detecting new episodes."
---

# Deactivate {{alerting-v2}} alerts [deactivate-alerts-v2]
