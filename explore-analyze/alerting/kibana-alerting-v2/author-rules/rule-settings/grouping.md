...
products:
  - id: kibana
description: "Split {{alerting-v2}} alert event generation by fields like host or service so each entity has independent lifecycle tracking."
---

# {{alerting-v2}} rule grouping [rule-grouping-v2]
