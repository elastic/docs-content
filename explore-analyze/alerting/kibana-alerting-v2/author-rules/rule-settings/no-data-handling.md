...
products:
  - id: kibana
description: "Configure {{alerting-v2}} rule behavior when the query returns no results: record no-data, carry forward status, or treat as recovery."
---

# {{alerting-v2}} no-data handling [no-data-handling-v2]
