...
* The [rule query inspector](troubleshoot-rule-behavior.md) lets you view the {{es}} request a rule sent during evaluation, confirm the rule is targeting the right data, and investigate rule behavior.
