...
* The [rule query inspector](inspect-rule-queries.md) lets you view the {{es}} request a rule sends during evaluation, confirm the rule is targeting the right data, and investigate rule behavior.
