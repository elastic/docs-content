...
For {{esql}} rules, you can use [`SET project_routing`](/explore-analyze/cross-project-search/cross-project-search-project-routing.md#cps-project-routing) in the rule query to target specific linked projects, overriding the space-level scope.
