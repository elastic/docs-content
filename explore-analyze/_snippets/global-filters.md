...
You can perform most of these actions at once for all filters in your current view using **Query menu**. From the menu that opens, select **Apply to all**, then choose the action you'd like to perform.
