...
* IP filtering is now available. Add IP filter policies to your Elastic Cloud Serverless projects to restrict incoming traffic to specific IP addresses or CIDR blocks.
