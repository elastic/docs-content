...
* Adds rich visual renderer for Entity Analytics attachments in Agent Builder with support for single-entity cards and multi-entity tables [#264985]({{kib-pull}}264985)
...
* Adds nightly maintenance task that automatically closes idle anomaly detection jobs with stopped datafeeds after a configurable timeout [#144904]({{es-pull}}144904)
...
* Fixes YAML download truncation at `#` characters in {{fleet}} standalone manifest [#264083]({{kib-pull}}264083)
...
* Fixes service map filter relayout, controls UI, and fit-view icon in APM [#265275]({{kib-pull}}265275)
