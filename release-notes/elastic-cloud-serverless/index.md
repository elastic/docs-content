...
* Adds global params sync internal API [#239284]({{kib-pull}}239284)
* Adds the ability to bulk mute and unmute alerts [#245690]({{kib-pull}}245690)
* Adds Rules feature privileges, allowing access to Rules to be explicitly set for user roles [#239634]({{kib-pull}}239634)
...
* Adds an Integration Knowledge platform tool [#245259]({{kib-pull}}245259)
* Adds Agent Builder UI settings, RBAC, navigation, and tour [#246089]({{kib-pull}}246089)
* Adds an Agent Builder opt-in flow [#244532]({{kib-pull}}244532)
...
* Adds a gap auto-fill scheduler UI and API [#244719]({{kib-pull}}244719)
...
* Adds a new gap fill status for rules [#242595]({{kib-pull}}242595)
...
* Adds dashboard suggestions for ECS K8s and OTel Dashboards when selecting pods in the Infra Inventory UI [#245784]({{kib-pull}}245784)
* Expands search in the All cases page [#245321]({{kib-pull}}245321)
