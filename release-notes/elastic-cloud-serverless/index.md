...
* Adds new fields to the Schedule exports flyout form for email notification: Cc, Bcc, and Subject and Message fields with Mustache templating support [#242922]({{kib-pull}}242922)
...
* Allows selecting the column type in the lookup index editor [#241637]({{kib-pull}}241637)
* Adds the **Read global parameters** sub-feature privilege which allows users to read the values of synthetics global parameters [#243821]({{kib-pull}}243821)
...
* Allows filtering alerts using the KQL search bar [#240100]({{kib-pull}}240100)
...
* Allows adding custom descriptions for enrichment processors [#243998]({{kib-pull}}243998)
...
* Allow users to configure the visibility of the Streams app per space [#244285]({{kib-pull}}244285)
...
* Ensures deleted text in form fields is not sent as empty string during Inference endpoint and AI Connector creation [#244059]({{kib-pull}}244059)
* Prevents cell selection from being cleared after dismissing the alerts table popover in Anomaly Explorer [#244183]({{kib-pull}}244183)
...
* Improves the error message in case the IBM Resilient connector fails [#244012]({{kib-pull}}244012)
