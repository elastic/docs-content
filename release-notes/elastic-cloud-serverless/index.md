...
* Enhances the SLO Details page to properly handle grouped SLOs when no specific instance is selected, allowing users to search SLO instances [#247638]({{kib-pull}}247638)
...
* Improves error handling for 429 errors from the Inference and AI connectors [#246640]({{kib-pull}}246640)
...
* Sets the default Node.js heap limit for containers to 75% of available memory, up to a maximum of 4096 MB (previously 50%) [#246073]({{kib-pull}}246073)
...
* Adds timezone support to add and sub operators and `ConfigurationAware` planning support in {{esql}} [#140101]({{es-pull}}140101)
...
* Increases the default top values for new Lens visualizations to 9 categories [#247015]({{kib-pull}}247015)
...
* Fixes the rule settings pop-up remaining open after clicking **Save** when enabling or disabling auto gap fill [#247678]({{kib-pull}}247678)
...
* Fixes the OpenAI connector's add header flow so newly added header key input receives focus instead of leaving focus on the **Add header** button [#248204]({{kib-pull}}248204)
...
* Fixes deleted async searches not showing on any API [#140385]({{es-pull}}140385)
