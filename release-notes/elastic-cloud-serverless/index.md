...
* Adds high-level rule execution info logging to the **Execution events** tab, showing matched events, alerts created, and alerts suppressed counts [#253992]({{kib-pull}}253992)
...
* Fixes the legacy `rules/prepackaged` endpoints from returning 500 errors on Basic license when rules include ML rules [#253574]({{kib-pull}}253574)
...
* Fixes an error in Streams AI pipeline suggestions when generated grok patterns contain empty strings [#251113]({{kib-pull}}251113)
