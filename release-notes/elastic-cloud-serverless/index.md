...
* Adds a platform cases tool as well as experimental security attachments and tools in Agent Builder to support existing **Ask AI Assistant** and **View in Agent Builder** workflows [#243574]({{kib-pull}}243574).
* Adds an alerts search tool as well as two security agents (Alerts Agent and Entity Agent) in Agent Builder [#245205]({{kib-pull}}245205)
...
* Enhances the Streams attachments feature with a details flyout and better user experience and feedback [#244880]({{kib-pull}}244880)
