...
* New rules callout in Metric, Logs, and Inventory rules in {{obs-serverless}} [#224387]({{kib-pull}}224387).
* Adds manual test for bulk import functionality in {{obs-serverless}} [#225497]({{kib-pull}}225497).
* Use `id` instead of `name` to group vulnerabilities by resource and cloud account in {{sec-serverless}} [#225492]({{kib-pull}}225492).
...
* Prevents selected document from changing when resizing the **Document** flyout in Discover with a keyboard [#225594]({{kib-pull}}225594).
