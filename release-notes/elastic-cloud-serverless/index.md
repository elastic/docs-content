...
* Allows you to search IP fields in controls using CIDR notation [#250875]({{kib-pull}}250875)
...
* Allows installation of integration-managed SLO templates by {{fleet}} [#250369]({{kib-pull}}250369)
* Improves the **By Value** embeddable editor flow [#250438]({{kib-pull}}250438)
* Improves timezone support [#247917]({{kib-pull}}247917)
* Adds query stats [#251029]({{kib-pull}}251029)
* Uses restorable state in doc viewer's **Table** tab [#249682]({{kib-pull}}249682)
* Adds health scans for SLOs [#248004]({{kib-pull}}248004)
* Supports KQL filtering in all types of aggregations in Custom Threshold rules [#248845]({{kib-pull}}248845)
...
* Updates package dependencies: adds `fast-xml-parser@^5.3.4` [#251644]({{kib-pull}}251644)
...
* adds `xpack.productDocBase.artifactRepositoryProxyUrl` setting to `kibana.yml` [#250771]({{kib-pull}}250771)
* Adds **Copy to clipboard** button for inference endpoint names in the Inference Endpoints management page [#251494]({{kib-pull}}251494)
* Adds a default model suggestion to AI Connector configuration menus [#250506]({{kib-pull}}250506)
* Adds descriptions to the semantic_text field inference endpoint selection interface [#249265]({{kib-pull}}249265)
* Introduces the SharePoint Online Data Source definition and related OOTB workflow YAML [#251544]({{kib-pull}}251544)
...
* Adds multimodal embedding task support to EIS [#141547]({{es-pull}}141547)
...
* Adds `task_settings` to completion command [#140613]({{es-pull}}140613)
* Adds count aggregation for histograms [#141138]({{es-pull}}141138)
* Blocks DiskBBQ encode doc vectors [#141598]({{es-pull}}141598)
* Adds multi-value field {{esql}} support for the `CHUNK` function [#141240]({{es-pull}}141240)
* Adds APM telemetry for the {{esql}} `SET` statement [#141719]({{es-pull}}141719)
* Adds logic to fold project tags metadata on data nodes [#141935]({{es-pull}}141935)
* Adds warning for Sort Under Lookup Join [#141482]({{es-pull}}141482)
* Adds failure store support for CCS [#139760]({{es-pull}}139760)
* Makes the `TDigest` field a time series metric. [#141386]({{es-pull}}141386)
* Optimizes search shard iterator sort [#140747]({{es-pull}}140747)
* Optimizes `TopNOperator` when the input is already sorted [#141094]({{es-pull}}141094)

### Fixes [serverless-changelog-02092026-fixes]

* Prevents QRadar building-block rules from unnecessary migration via Automatic Migration [#250558]({{kib-pull}}250558)
...
* Fixes a11y issue with missing label in the flyout component [#251656]({{kib-pull}}251656)
* Fixes ARIA announcement bug in the **Add exception list** dialog [#250624]({{kib-pull}}250624)
* Fixes Timeline automatically opening from the Network page [#250469]({{kib-pull}}250469)
* Fixes flyout section local storage not honoring all values [#251999]({{kib-pull}}251999)
* Fixes share feature rounding [#251073]({{kib-pull}}251073)
* Hides links on the Search homepage for users without access [#251437]({{kib-pull}}251437)
* Add a badge to the Agent Builder UI when your license doesn't support it [#251484]({{kib-pull}}251484)
...
* Fix `TO_IP` `leading_zeros=octal` {{esql}} parsing [#141776]({{es-pull}}141776)
* Prevents a possible NPE by instead throwing an EIAE with more info [#141711]({{es-pull}}141711)
* Improves handling of duplicate {{esql}} doc IDs [#142055]({{es-pull}}142055)
* Fixes `IP_PREFIX` {{esql}} function leaking data in scratch [#141940]({{es-pull}}141940)
* Reuses Block Reader only when few fields [#141672]({{es-pull}}141672)
...
* Allows shadowing of timeseries parameters in non timeseries mappings [#141549]({{es-pull}}141549)
