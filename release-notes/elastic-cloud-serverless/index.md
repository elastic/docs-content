...
* Fixes an issue where schedules and conversations referencing outdated Preconfigured AI Connector connector IDs failed to execute or display correctly [#249891]({{kib-pull}}249891)
...
* Adds two new preconfigured connectors (General Purpose LLM v2 and General Purpose LLM v3) and renames the Preconfigured AI Connector connector to General Purpose LLM v1 [#242791]({{kib-pull}}242791)
...
* Ensures validation logic so the Preconfigured AI Connector behaves as expected during testing [#231873]({{kib-pull}}231873)
...
* Improves error handling in **Search Playground** when context limit is exceeded using Preconfigured AI Connector [#225360]({{kib-pull}}225360)
...
* Fixes handling of context limit errors in Playground when using the Preconfigured AI Connector [#225360]({{kib-pull}}225360)
