...
* Introduces a **Find Alert Rule Templates** API and uses it to show installed templates in the Create rule modal [#245373]({{kib-pull}}245373)
* Adds a math processor for data transformations [#246050]({{kib-pull}}246050)
* Allows users to manage SLO stale threshold settings in serverless [#246760]({{kib-pull}}246760)
...
* Adds a server setting to turn off automatic endpoint rule installation when creating a policy [#246418]({{kib-pull}}246418)
* Updates Kibana MITRE data to version 18.1 [#246770]({{kib-pull}}246770)
...
* Fixes compound filters incorrectly showing unsaved changes when loading dashboards [#247309]({{kib-pull}}247309)
...
* Fixes handling of special characters in ES|QL queries for risk scoring [#247060]({{kib-pull}}247060)
...
* Requires the `manage` permission to perform bulk actions on Stream Features [#246129]({{kib-pull}}246129)
