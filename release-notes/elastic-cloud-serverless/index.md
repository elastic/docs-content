...
* Improves the ES|QL suggestions logic when a query changes [#231767]({{kib-pull}}231767)
...
* Extends ES|QL autocomplete to include columns from lookup indices and enrichment policies after `LOOKUP JOIN` and `ENRICH` commands [#233221]({{kib-pull}}233221)
...
* Restricts access to **Value report** to `admin` and `soc_manager` roles in complete tier [#234377]({{kib-pull}}234377)
* Ensures **Tech Preview** badge is shown for the default inference endpoint for e5 on the inference endpoints UI [#234811]({{kib-pull}}234811)
...
* Fixes issues in AI Assistant where conversation messages were not appended and titles were not updated [#233219]({{kib-pull}}233219)
