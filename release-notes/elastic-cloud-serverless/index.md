...
* Allows to navigate to a dashboard and also carry the controls, preserving the historgram [#237070]({{kib-pull}}237070)
...
* Disables the maximum attempts limit for the private locations sync task [#237784]({{kib-pull}}237784)
...
* Fixes the crashing of the flyout on the Files management page when there were uploaded files [#237588]({{kib-pull}}237588)
