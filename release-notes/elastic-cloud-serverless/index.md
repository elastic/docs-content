...
* Adds Confluence Cloud as a data source for Workplace AI, letting users connect via Basic auth to list and retrieve spaces and pages [#256508]({{kib-pull}}256508)
...
* Adds `semantic_text` field type to MMR Result Diversification Retriever (v2) [#141666]({{es-pull}}141666)
...
* Fixes {{esql}} suggestions logic in **Lens** [#258475]({{kib-pull}}258475)
...
* Fixes alert tags when source tags is a string [#259729]({{kib-pull}}259729)
