...
* Auto-scrolls to the Suggestions/Regenerate panels [#242891]({{kib-pull}}242891)
...
* Uses the real dimensions when taking a screenshot [#242127]({{kib-pull}}242127)
* Fixes a print mode regression in Dashboards [#242780]({{kib-pull}}242780)
* Fixes an issue where users could not save a dashboard after switching a Dashboard Link to an External Link [#243134]({{kib-pull}}243134)
* Uses `max_value` instead of infinity [#243572]({{kib-pull}}243572)
