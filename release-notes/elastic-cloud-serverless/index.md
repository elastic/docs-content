...
* Enables monospaced numeric font rendering for Lens charts, including axis labels, legend values, data labels, and tooltips [#251576]({{kib-pull}}251576)
...
* Adds manual entity resolution UI to the entity details flyout [#260162]({{kib-pull}}260162)
...
* Adds AI-assisted onboarding option to the {{es}} getting started page [#255192]({{kib-pull}}255192)
...
* Adds `linux.advanced.ransomware.diagnostic` advanced flag in preparation for Linux ransomware release [#260538]({{kib-pull}}260538)
...
* Adds `TopNBy` logical plan node to enable `SORT | LIMIT BY` commands in {{esql}} [#144279]({{es-pull}}144279)
...
* Fixes alert recovery targeting wrong document when multiple lifecycles exist for the same instance ID [#261012]({{kib-pull}}261012)
...
* Fixes `STATS` generated columns with inline `WHERE` clause in {{esql}} [#260196]({{kib-pull}}260196)
...
* Shows latest available version information in the Upgrade Assistant overview [#259798]({{kib-pull}}259798)
* Fixes an issue where the **Leave without saving?** modal reappeared after cancelling a solution view change [#260958]({{kib-pull}}260958)
* Fixes the anomaly swim lane embeddable refresh [#259962]({{kib-pull}}259962)
* Adds attachment origin to Converse API [#259043]({{kib-pull}}259043)
...
* Fixes circuit breaker leak in percolator query construction [#144827]({{es-pull}}144827)
