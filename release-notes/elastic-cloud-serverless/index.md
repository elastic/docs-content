...
* Disables the output selector for managed policies in the package policy edit form [#263494]({{kib-pull}}263494)
...
* Fixes APM routing and settings [#262723]({{kib-pull}}262723)
...
* Suppresses the announcement modal in automated browsers via `navigator.webdriver` [#263785]({{kib-pull}}263785)
...
* Shows a save confirmation message after saving changes on the **Feature Settings** page [#263768]({{kib-pull}}263768)
...
* Fixes the `deriv` aggregation function intermediate state [#146160]({{es-pull}}146160)
