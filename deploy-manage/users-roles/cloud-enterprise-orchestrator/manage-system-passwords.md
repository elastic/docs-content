...
For additional usage examples, check [`elastic-cloud-enterprise.sh reset-adminconsole-password` Reference](cloud://docs/reference/cloud/cloud-enterprise/ece-installation-script-reset.md).
