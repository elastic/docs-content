...
:   Grants access to all {{kib}} features in all spaces. For more information on {{kib}} authorization, see [{{kib}} authorization](../../../deploy-manage/users-roles/cluster-or-deployment-auth/built-in-roles.md).

$$$built-in-roles-kibana-user$$$ `kibana_user`
:   This role is deprecated, please use the [`kibana_admin`](../../../deploy-manage/users-roles/cluster-or-deployment-auth/built-in-roles.md#built-in-roles-kibana-admin) role instead. Grants access to all features in {{kib}}..
