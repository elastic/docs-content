...
3. Specification for document fields the owners of the role have read access to. See [Setting up field and document level security](/deploy-manage/users-roles/controlling-access-at-document-field-level.md) for details.
...
4. Specification for document fields the owners of the role have read access to. See [Setting up field and document level security](/deploy-manage/users-roles/controlling-access-at-document-field-level.md) for details.
