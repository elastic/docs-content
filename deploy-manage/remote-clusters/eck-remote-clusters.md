...
1. This requires the sample data: [/explore-analyze/index.md#gs-get-data-into-kibana](https://www.elastic.co/guide/en/kibana/current/get-started.html#gs-get-data-into-kibana)
