...
It shows only what is currently running. 

For historical query data, use:
- {applies_to}`stack: preview 9.4` {applies_to}`serverless: unavailable` [query logs](/deploy-manage/monitor/logging-configuration/query-logs.md)
- [AutoOps](/deploy-manage/monitor/autoops.md)
