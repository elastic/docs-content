...
Ignore filters exclude matching events *before* delivery, reducing the volume of your delivery and the overall cost. If you don't choose any ignore filters, *all* events for your chosen log type will be delivered. This is the highest volume option and directly affects your {{serverless-short}} bill. 
