...
On the Search Tier page, the top half of the screen offers high-level insights. Use the following features to explore this view:
...
1. The **number of documents** in the index or data stream.
2. The latest **search rate** in the selected time period.
3. The latest **search latency** in the selected time period.
4. The **timestamp** of the most recent search on the index or data stream.
...
The Search Tier view shows you how many Search VCUs are consumed in your project and how your usage changes over time. This section explains what might be causing these changes in your VCU consumption. 
