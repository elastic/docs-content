...
For advanced views or production monitoring, [enable logging and monitoring](../stack-monitoring/ece-ech-stack-monitoring.md). The monitoring application provides more advanced views for Elasticsearch and JVM metrics, and includes a configurable retention period.
