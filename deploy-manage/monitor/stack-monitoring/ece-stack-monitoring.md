...
With monitoring enabled for your deployment, you can access the [logs](/solutions/observability.md) and [stack monitoring](../monitoring-data/visualizing-monitoring-data.md) through Kibana.
