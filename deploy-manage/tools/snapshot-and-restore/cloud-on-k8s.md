...
11. Create a snapshot repository of type `azure` through the {{es}} API, or through [*Elastic Stack configuration policies*](../../deploy/cloud-on-k8s/elastic-stack-configuration-policies.md).
