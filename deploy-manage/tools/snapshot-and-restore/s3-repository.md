...
`protocol` {applies_to}`stack: deprecated 8.19 removed 10.0+`
...
`unsafely_incompatible_with_s3_conditional_writes` {applies_to}`stack: ga 9.2.3 deprecated 9.2.4 removed 10.0+`
