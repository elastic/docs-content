...
Changing the `storage_class`, `data_storage_class`, or `metadata_storage_class` settings on an existing repository only affects the storage class for newly created objects, resulting in a mixed usage of storage classes.
