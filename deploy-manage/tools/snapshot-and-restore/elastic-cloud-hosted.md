...
In **{{ech}}**, snapshot repositories are automatically registered for you, but you can create additional repositories if needed, using any of the following methods:
