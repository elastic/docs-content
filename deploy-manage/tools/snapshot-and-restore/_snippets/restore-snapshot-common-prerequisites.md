* To use {{kib}}'s **Snapshot and Restore** feature, you must have the following permissions:
    ...
    * [Cluster privileges](elasticsearch://reference/elasticsearch/security-privileges.md#privileges-list-cluster): `monitor`, `manage_slm`, `cluster:admin/snapshot`, `cluster:admin/repository`, and `cluster:admin/settings/update`
