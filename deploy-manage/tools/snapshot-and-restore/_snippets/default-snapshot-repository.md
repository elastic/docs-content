The default snapshot repository stores all snapshots generated by data stream lifecycle management. The first repository you register in {{kib}} becomes the default automatically, and you can change which repository is the default at any time. The default repository is marked with a **Default** badge in the repositories list and the repository details flyout.
