...
For {{es}} clusters in version 7.x you must add the S3 repository plugin to your cluster. Refer to [Add plugins and bundles in {{ece}}](/deploy-manage/plugins-and-bundles/cloud-enterprise/add-plugins.md) for more details.
