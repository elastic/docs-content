...
::::{tip}
You can modify dynamic [remote recovery settings](elasticsearch://docs/reference/elasticsearch/configuration-reference/cross-cluster-replication-settings.md#ccr-recovery-settings) to rate-limit the transmitted data and manage the resources consumed by remote recoveries.
::::
...
* [System indices](elasticsearch://docs/reference/elasticsearch/rest-apis/api-conventions.md#system-indices)
...
* [Cluster settings](elasticsearch://docs/reference/elasticsearch/configuration-reference/cluster-level-shard-allocation-routing-settings.md)
