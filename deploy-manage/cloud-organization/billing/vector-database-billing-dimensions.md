...
* **Search** — Measured by the resources allocated to keep your data hot. Allocation is controlled by your project's [Search Power](/deploy-manage/deploy/elastic-cloud/project-settings.md#elasticsearch-manage-project-search-power-settings) setting.
...
Search charges cover the resources used to keep your data hot for active searches. All stored data is hot by default, which means it actively contributes to Search charges.
