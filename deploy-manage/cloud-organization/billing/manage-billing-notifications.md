...
* **Cloud resource** budgets track specific resources, which can include {{ech}} deployments, {{serverless-short}} projects, and connected clusters. To view one, you need to be able to view every resource in its scope. To create, edit, or delete one, you need to be able to manage every resource in its scope. Which [role](/deploy-manage/users-roles/cloud-organization/user-roles.md) you need differs by resource type.
