...
* [](/deploy-manage/app-connections.md): Register OAuth clients and manage application connections for authorized third-party access. {applies_to}`serverless: preview`
