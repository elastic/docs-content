...
* **{{stack}} deployments:** Controlled by the `xpack.spaces.maxSpaces` setting. Default is 1000. [View the full list of Space settings](asciidocalypse://docs/kibana/docs/reference/configuration-reference/spaces-settings.md).
