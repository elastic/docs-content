...
{{observability}} apps have limited {{cps-init}} support. APM and Infrastructure use the header scope selector. SLOs store project scope on each SLO. Other {{observability}} apps remain scoped to the origin project.
