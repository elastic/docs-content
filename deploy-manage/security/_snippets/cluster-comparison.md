...
| | Kubernetes network policies | N/A |  |
| | Published static IP ranges (ingress and egress) | N/A | Not offered as Elastic-published ranges for {{serverless-short}}. Use [private connectivity](/deploy-manage/security/private-connectivity.md) where supported. |
...
| | Published static IP ranges (ingress and egress) | N/A | Use your own stable IPs where you need them for allowlists or firewalls, and [Manage HTTP certificates on ECK](/deploy-manage/security/k8s-https-settings.md) so HTTP TLS matches the hostnames and addresses you expose. |
| **Data** | Encryption at rest | N/A |  |
...
| | Private connectivity and VPC filtering | N/A |  |
| | Kubernetes network policies | N/A |  |
| | Published static IP ranges (ingress and egress) | N/A | Use static IPs and firewall rules on hosts and load balancers you operate. |
| **Data** | Encryption at rest | N/A |  |
