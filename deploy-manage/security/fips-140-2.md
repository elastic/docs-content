...
- Elastic provides FIPS-compliant versions of several [Ingest tools](/deploy-manage/security/fips-ingest.md), including {{agent}}, {{fleet}}, {{filebeat}}, {{metricbeat}}, and APM Server.
...
FIPS compatible binaries are available and can be configured to use FIPS 140-2 compliant cryptography:
