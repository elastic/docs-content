...
:::{note}
Currently, {{es}} and {{kib}} support this feature. Support for additional components that connect to {{es}} ({{beats}}, {{agent}}, {{apm-server}}, {{ls}}, etc.) will follow in future releases.
:::
