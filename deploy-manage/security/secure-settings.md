...
### Reloadable settings [reloadable-secure-settings]
...
```
1. If the {{es}} keystore is password-protected, include the `secure_settings_password` parameter in the request body with the keystore password.
