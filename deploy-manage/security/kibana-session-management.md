...
To manage user sessions programmatically, {{kib}} exposes [session management APIs]({{kib-apis}}group/endpoint-user-session). For details, check out [Session and cookie security settings](kibana://reference/configuration-reference/security-settings.md).
