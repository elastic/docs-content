...
You can address such issues by tweaking the [Task Manager settings](kibana://docs/reference/configuration-reference/task-manager-settings.md#task-manager-settings) or scaling the deployment to better suit your use case.
