...
Before upgrading, refer to the [release notes](cloud-on-k8s://docs/release-notes/elastic-cloud-kubernetes.md) to make sure that the release does not contain any breaking changes that could affect you.
