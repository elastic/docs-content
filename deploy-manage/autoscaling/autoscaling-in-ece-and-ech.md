...
You can also have a look at our [autoscaling example](ece-autoscaling-example.md), as well as a sample request to [create an autoscaled deployment through the API](autoscaling-api-example.md).
