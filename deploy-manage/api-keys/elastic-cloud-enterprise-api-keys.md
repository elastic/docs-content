...
2. Specify the bearer token in the Authentication header of your API requests. To learn more, check [accessing the API from the command line](cloud://docs/reference/cloud/cloud-enterprise/ece-api-command-line.md).
