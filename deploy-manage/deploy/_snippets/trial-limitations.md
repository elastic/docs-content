...
* We monitor token usage per account for the Preconfigured AI Connector. If an account uses over one million tokens in 24 hours, we will inform you, then remove access to the LLM. This is in accordance with our fair use policy for trials. 
...
* We monitor token usage per account for the Preconfigured AI Connector. If an account uses over one million tokens in 24 hours, we will inform, then remove access to the LLM. This is in accordance with our fair use policy for trials. 
