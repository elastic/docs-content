...
| Feature/capability | Fully self-managed, ECE, ECK, ECH | {{serverless-short}} |
|-------------------|-------------------------------|----------------------|
| [Reporting](/explore-analyze/report-and-share.md) | All report types and file formats | CSV for Discover sessions and Lens visualizations.<br><br>JSON for dashboards.<br><br>JSON for Discover sessions (preview).<br><br>PDF and PNG are not available. |
