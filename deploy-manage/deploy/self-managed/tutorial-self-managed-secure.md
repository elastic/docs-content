...
Before starting, you must have an on-premises {{es}} cluster with {{kib}} already set up, following the steps in [Tutorial 1: Installing a self-managed {{stack}}](tutorial-self-managed-install.md).
