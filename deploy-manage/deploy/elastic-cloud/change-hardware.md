...
The virtual hardware on which Elastic stack deployments run is defined by instance configurations. To learn more about what an instance configuration is, refer to [Instance configurations](cloud://docs/reference/cloud/cloud-hosted/hardware.md#ec-getting-started-configurations).
...
1. From the  [list of instance configurations available for each region](cloud://docs/reference/cloud/cloud-hosted/ec-regions-templates-instances.md), select the target instance configuration you want to migrate to.
