...
| ![vectordb](../../images/64x64_Color_vectordb-logo-color-64px.png "vectordb =50%") | **{{es}} {{vectordb}}**<br> Build vector-centric applications for semantic search, RAG, or AI retrieval, with built-in inference and vector-optimized defaults.<br><br>[**View guide →**](/solutions/vector-database/get-started.md)<br> |
