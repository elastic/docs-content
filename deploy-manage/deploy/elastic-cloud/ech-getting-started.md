...
[Elasticsearch Machine Learning](/explore-analyze/machine-learning.md), [Elastic APM](/solutions/observability/apps/application-performance-monitoring-apm.md) and [Elastic Fleet Server](docs-content://docs/reference/ingestion-tools/fleet/index.md) are not supported by the Elasticsearch Add-On for Heroku.
