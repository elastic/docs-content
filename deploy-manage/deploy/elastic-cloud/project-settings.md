...
| :--- | :--- |
| **Elastic AI SOC Engine (EASE)** | A package of AI-powered tools meant to work with and enhance your existing SOC platforms: alert triage and correlation with Attack Discovery, get realtime recommendations and assistance from AI Assistant, and share insights with your other tools.  |
