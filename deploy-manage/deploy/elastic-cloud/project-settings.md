...
- {applies_to}`serverless: preview` **[Log delivery](/deploy-manage/monitor/log-delivery.md)**: Ship selected log types, starting with audit trail, to a {{sec-serverless}} or {{obs-serverless}} project in your organization.
