...
::::{important}
* vCPU credits temporarily assigns extra CPU resources beyond the default
* vCPU credits are not always guaranteed and may be reset during essential maintenance
::::
