...
# Azure Native ISV Service troubleshooting

$$$ec-azure-integration-troubleshooting$$$

This page describes some scenarios that you might experience onboarding to {{ecloud}} through the Azure console. If you're running into issues, you can always [get support](#azure-integration-support).


## Authorization errors

When trying to access {{ecloud}} resources, you might get an error message indicating that the user must have the required authorization.
...
1. Navigate to the [resource overview page](https://portal.azure.com/#browse/Microsoft.Elastic%2Fmonitors) in the Azure console.
