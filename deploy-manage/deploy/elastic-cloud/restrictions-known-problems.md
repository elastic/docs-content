...
* Due to a known issue, {{es}} 8.17.0 through 8.17.4, 8.18.0, and 9.0.0 through 9.0.1 may experience significant vector search performance degradation on Ubuntu 24.04. An interaction between Multi-Gen LRU (MGLRU) and Lucene read-advice behavior can cause excessive page faults and I/O during vector operations. Elastic begins an incremental upgrade of {{ecloud}} infrastructure to Ubuntu 24.04 on November 20, 2026. If you run an affected version, upgrade before that date:
