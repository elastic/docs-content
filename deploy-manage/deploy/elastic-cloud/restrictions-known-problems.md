...
* Due to a known issue with the {{stack}} (See [Elasticsearch Known Issues](https://www.elastic.co/docs/release-notes/elasticsearch/known-issues#elasticsearch-9.2.4-known-issues)), the upgrade path from 9.1.10 to 9.2.4 is disabled. For more information, review [this KB article](TBD).
