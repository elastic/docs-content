...
* Due to a known issue with the {{stack}}, the upgrade path from 9.1.10 to 9.2.4 is disabled. For reference on the underlying problem, see [Elasticsearch Known Issues](https://www.elastic.co/docs/release-notes/elasticsearch/known-issues#elasticsearch-9.2.4-known-issues)), 
