...
A: You can [use Reindex from remote](https://www.elastic.co/docs/reference/elasticsearch/rest-apis/reindex-indices#reindex-from-remote) as the most direct and managed
