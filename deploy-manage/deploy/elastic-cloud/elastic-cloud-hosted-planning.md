...
* **{{kib}} nodes/instances**: For production systems, we recommend that each {{kib}} node/instance in your cluster has at least 2 GB of RAM. Below this size, Platinum and Enterprise features such as Security Detection Rules, Reporting, Workflows, and Agent Builder might be unavailable or cause service interruptions.  {{kib}} instances in new {{ech}} deployments have 2 GB of RAM by default.
