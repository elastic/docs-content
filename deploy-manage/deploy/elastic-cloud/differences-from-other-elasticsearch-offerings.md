...
| **[Reporting](/explore-analyze/report-and-share.md)** | ✅ PDF, PNG, and CSV (generate and schedule) | Discover CSV generate and schedule only | Dashboard and visualization PDF/PNG are not available on Serverless. Lens CSV download is available; Lens CSV scheduling is not supported on {{ech}} or Serverless. |
