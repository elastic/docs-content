...
| **[Reporting](/explore-analyze/report-and-share.md)** | ✅ All report types and file formats | ✅ Discover CSV, Lens CSV, Dashboard JSON, Discover session JSON (preview)<br><br>❌ Dashboard and visualization PDF and PNG | |
