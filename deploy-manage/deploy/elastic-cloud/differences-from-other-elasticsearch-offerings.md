...
| **[Native realm authentication](/deploy-manage/users-roles/cluster-or-deployment-auth/native.md)** | ✅ | ❌ | {{serverless-short}} does not support {{es}} authentication realms. Users are handled at the [organization level](/deploy-manage/users-roles/cloud-organization.md). |
