...
| **Backups** | User-managed with Snapshot & Restore | Automatically backed up by Elastic. Customers may request restoration via [Support](https://support.elastic.co/knowledge/94022085). |
