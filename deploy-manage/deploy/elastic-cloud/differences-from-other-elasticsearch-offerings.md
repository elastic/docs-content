...
| **Custom plugins and bundles** | ✅ | ✅ [Core analysis plugins](elasticsearch://reference/elasticsearch-plugins/analysis-plugins.md) (bundled)<br><br>❌ Custom plugin/bundle uploads<br><br>❌ Custom dictionaries for [language analyzers](elasticsearch://reference/text-analysis/analysis-lang-analyzer.md) | Use the [synonyms APIs]({{es-apis}}group/endpoint-synonyms) for synonyms in Serverless. |
