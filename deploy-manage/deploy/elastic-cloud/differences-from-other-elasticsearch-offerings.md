...
| [**Synonyms**](https://www.elastic.co/docs/solutions/search/full-text/search-with-synonyms) | - Index time synonyms <br>-File-based synonyms <br>-Synonyms API | - Synonyms API only | |
