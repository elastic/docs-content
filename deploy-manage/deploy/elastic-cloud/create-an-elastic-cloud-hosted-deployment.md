...
* [Add plugins and extensions](/deploy-manage/plugins-and-bundles/elastic-cloud/add-plugins-extensions.md) to use Elastic supported plugins or add your own custom dictionaries and scripts.
