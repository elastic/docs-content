...
The Logstash Keystore can be password protected by setting an environment variable called `LOGSTASH_KEYSTORE_PASS`. Check out [Logstash Keystore](logstash://docs/reference/ingestion-tools/logstash/keystore.md#keystore-password) documentation for details.
