...
For more details, check the [Beats configuration](beats://docs/reference/ingestion-tools/beats-libbeat/config-file-format.md) section.
...
Check [Beats documentation](beats://docs/reference/ingestion-tools/beats-filebeat/keystore.md) for more details.
