...
Check out [Add plugins and configuration files in {{eck}}](/deploy-manage/plugins-and-configuration-files/cloud-on-k8s/manage-plugins.md) for more details on which option might be most suitable for you.
