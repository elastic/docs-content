...
Check out [Install plugins on {{eck}}](/deploy-manage/plugins-and-configuration-files/cloud-on-k8s/manage-plugins.md#install-plugins) for more details on which option might be most suitable for you.
