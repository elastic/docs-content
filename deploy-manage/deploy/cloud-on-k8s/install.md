...
* The **FIPS** operator image is hardened following FIPS 140-2 requirements. Refer to [Deploy a FIPS-compatible version of ECK](./deploy-fips-compatible-version-of-eck.md) for details.
