...
If you want to configure Wolfi images for the {{stack}} components rather than the ECK operator itself, refer to [Use Wolfi images for stack components](./wolfi-stack-images.md).
