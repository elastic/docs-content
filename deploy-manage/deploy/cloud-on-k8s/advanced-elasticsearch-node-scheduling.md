...
You can configure Elasticsearch nodes with [one or multiple roles](elasticsearch://docs/reference/elasticsearch/configuration-reference/node-settings.md).
