...
::::{tip}
For a detailed list and description of all available settings in ECK, refer to [ECK configuration flags](cloud-on-k8s://docs/reference/cloud/cloud-on-k8s/eck-configuration-flags.md).
::::
...
The following shows the default `elastic-operator` ConfigMap, for reference purposes. Refer to [ECK configuration flags](cloud-on-k8s://docs/reference/cloud/cloud-on-k8s/eck-configuration-flags.md) for a complete list of available settings.
