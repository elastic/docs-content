...
The following example describes option 2, using a repository plugin. To install the plugin before the Elasticsearch nodes start, use an init container to run the [plugin installation tool](elasticsearch://docs/reference/elasticsearch-plugins/installation.md).
