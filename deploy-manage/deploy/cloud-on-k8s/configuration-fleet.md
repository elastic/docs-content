...
spec:
  config:
    xpack.fleet.agents.elasticsearch.hosts: ["<ELASTICSEARCH_HOST>-es-http.default.svc:9200"]
...
spec:
  config:
    ...
    xpack.fleet.agents.fleet_server.hosts: ["<FLEET_SERVER_HOST>-agent-http.default.svc:8220"]
    xpack.fleet.outputs:
    - id: eck-fleet-agent-output-elasticsearch
      ...
      type: elasticsearch
      hosts:
      - "<ELASTICSEARCH-HOST>-es-http.default.svc:9200" <2>
      ssl:
