...
{{ece}} 4 no longer supports {{stack}} versions prior to 8.0.0. All deployments must be upgraded to stack version 8.0.0 or later, prior to upgrading to ECE 4.0. Review [{{ece}} compatibility matrix](https://www.elastic.co/support/matrix#matrix_compatibility:~:text=Compatibility%20with%20Elastic%20Cloud%20Enterprise%20ECE) for more guidance.
:::
