...
{{ece}} 4 no longer supports {{stack}} versions prior to 8.0.0. All deployments must be upgraded to stack version 8.0.0 or later, prior to upgrading to ECE 4.0. Review [Product Compatibility matrix > Compatibility with {{ece}}](https://www.elastic.co/support/matrix#matrix_compatibility) for more guidance.
:::
