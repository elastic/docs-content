...
For more information on configuring the `TransportClient`, see [Configure the Java Transport Client](elasticsearch-java://docs/reference/elasticsearch/elasticsearch-client-java-api-client/index.md).
