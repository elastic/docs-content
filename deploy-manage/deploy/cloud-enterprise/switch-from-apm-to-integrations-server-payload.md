...
This example shows how to use the Elastic Cloud Enterprise RESTful API to switch from using [APM & Fleet Server](https://www.elastic.co/guide/en/cloud-enterprise/3.7/ece-manage-apm-and-fleet.html) to [Integrations Server](manage-integrations-server.md).
