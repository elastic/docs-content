...
::::{note}
There is currently no UI option to change JVM heap sizes after installation. If you need to change them, refer to [our KB article](https://ela.st/change-ece-jvm-heap) for guidance.
::::
