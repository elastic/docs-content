...
* [](/deploy-manage/plugins-and-configuration-files/cloud-enterprise/add-plugins-provided-with-ece.md): Enable or disable plugins from the list of available extensions in ECE.
* [](/deploy-manage/plugins-and-configuration-files/cloud-enterprise/add-custom-bundles-plugins.md): Add custom plugins or external configuration files to your {{es}} instances.
