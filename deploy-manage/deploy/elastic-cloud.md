...
You can check the operational status of {{ecloud}} at any time from [status.elastic.co](https://status.elastic.co/). If you are on a FedRAMP High deployment, use the [FedRAMP High status page](https://ela.st/fedramphighstatus) instead.
