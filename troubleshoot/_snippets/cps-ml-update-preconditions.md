...
```txt
Rollback model snapshot [snapshot_2026-07-01] retained before project_routing scope change: Automatic rollback snapshot retained before project_routing scope change [_alias:_origin] -> [_alias:prod-*]
```
