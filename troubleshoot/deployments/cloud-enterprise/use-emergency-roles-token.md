...
4. Optional: Prevent a recurrence of the issue by enabling high availability for the administration console:
    ...
    1. Repeat Step 1 to create two additional coordinators in two additional availability zones. [Examples of the installation commands](cloud://docs/reference/cloud/cloud-enterprise/ece-installation-script.md#ece-installation-script-examples) you need to run are available.
