...
You can view the status of deployment actions and get additional information on events, including why a particular event fails for example misconfiguration details.
