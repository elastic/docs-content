...
Both SDK-level and Collector-based sampling can result in gaps in telemetry if misconfigured. Refer to [Missing or incomplete traces due to Collector sampling](/troubleshoot/ingest/opentelemetry/otel-collector/misconfigured-sampling-collector.md) for more details.
...
- For more control (for example "keep all errors, sample 10% of successes"), use Collector tail sampling.
    ...
    For more information, refer to [Missing or incomplete traces due to Collector sampling](/troubleshoot/ingest/opentelemetry/otel-collector/misconfigured-sampling-collector.md).
:::
...
- [Missing or incomplete traces due to Collector sampling](/troubleshoot/ingest/opentelemetry/otel-collector/misconfigured-sampling-collector.md)
