...
2. Inspect the [`index.number_of_replicas`](elasticsearch://docs/reference/elasticsearch/index-settings/index-modules.md#dynamic-index-number-of-replicas) index setting.
...
Alternatively, if adding more nodes to the {{es}} cluster is not desired, inspect the [`index.number_of_replicas`](elasticsearch://docs/reference/elasticsearch/index-settings/index-modules.md#dynamic-index-number-of-replicas) index setting and decrease the configured value:

1. Inspect the [`index.number_of_replicas`](elasticsearch://docs/reference/elasticsearch/index-settings/index-modules.md#dynamic-index-number-of-replicas) index setting for the index with unassigned replica shards:
