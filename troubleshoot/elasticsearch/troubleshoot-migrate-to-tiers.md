...
6. [Migrate to data tiers](../../manage-data/lifecycle/data-tiers.md)
    ...
    2. The indices that were migrated to [tier preference](elasticsearch://docs/reference/elasticsearch/index-settings/data-tier-allocation.md#tier-preference-allocation-filter) routing.
