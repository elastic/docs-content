...
{{es}} is using data nodes to distribute your data inside the cluster. If one or more of these nodes are running out of space, {{es}} takes action to redistribute your data within the nodes so all nodes have enough available disk space. Refer also to [Watermark errors](/troubleshoot/elasticsearch/fix-watermark-errors.md) troubleshooting.
