...
* [Installing plugins in self-managed clusters](/deploy-manage/plugins-and-configuration-files/self-managed/manage-plugins.md)
* [Installing plugins on {{eck}}](/deploy-manage/plugins-and-configuration-files/cloud-on-k8s/manage-plugins.md)
