...
Modifying to the [nested](elasticsearch://docs/reference/elasticsearch/mapping-reference/nested.md) data type would not resolve the core issue.
...
* [Export](logstash://docs/reference/ingestion-tools/logstash/plugins-inputs-elasticsearch.md) and [re-import](logstash://docs/reference/ingestion-tools/logstash/plugins-outputs-elasticsearch.md) data into a mapping-corrected index after [pruning](logstash://docs/reference/ingestion-tools/logstash/plugins-filters-prune.md) problematic fields via Logstash.
