...
To restore system indices from a snapshot, follow the same procedure described in [](index.md#ec-restore-snapshots) and select the appropriate feature states when preparing the restore operation, such as `kibana` or `security`.
