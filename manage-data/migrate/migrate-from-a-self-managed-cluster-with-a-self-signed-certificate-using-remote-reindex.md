...
You can now run a remote reindex operation on the {{ech}} `Destination` cluster from the `Source` cluster, as described in the [migration guide](/migrate/elasticsearch-data/index.md#ech-reindex-remote):
