...
The [`index.routing.allocation.include._tier_preference`](elasticsearch://docs/reference/elasticsearch/index-settings/data-tier-allocation.md#tier-preference-allocation-filter) setting determines which tier the index should be allocated to.
