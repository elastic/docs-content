...
* {applies_to}`stack: ga 9.5+` Move older backing indices to low-cost searchable storage. Refer to [](/manage-data/lifecycle/data-stream/frozen-searchable-snapshots.md).
...
5. {applies_to}`stack: ga 9.5+` Transitions eligible backing indices to partially mounted {{search-snaps}}. Refer to [](/manage-data/lifecycle/data-stream/frozen-searchable-snapshots.md).
