...
1. In **Discover**, the list of documents shows the columns for fields applicable to the visualization that you selected. Select any document that has data for those fields, then select the **View details** icon (or **Toggle dialog with details** in earlier {{stack}} versions).
