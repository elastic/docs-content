...
* To drill down into the index [mappings](../../data-store/mapping.md), [settings](elasticsearch://docs/reference/elasticsearch/index-settings/index.md), and statistics, click an index name. From this view, you can navigate to **Discover** to further explore the documents in the index.
...
3. Define a mapping that contains an [object](elasticsearch://docs/reference/elasticsearch/mapping-reference/object.md) field named `geo` with a child [`geo_point`](elasticsearch://docs/reference/elasticsearch/mapping-reference/geo-point.md) field named `coordinates`:
...
* An optional [query](elasticsearch://docs/reference/query-languages/query-dsl-match-all-query.md).
