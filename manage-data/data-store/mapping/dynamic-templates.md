...
2. The `my_string` field is mapped as a `text`, with a `keyword` [multi-field](elasticsearch://docs/reference/elasticsearch/mapping-reference/multi-fields.md).
