...
::::{tip}
For a user interface to query, visualize, and manage your {{es}} data, refer to [Kibana](/explore-analyze/index.md). Kibana provides visualization tools, index management, and sample data sets you can use to explore its capabilities.
::::
