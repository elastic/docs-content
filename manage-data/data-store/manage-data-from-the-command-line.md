...
::::{tip}
If you are looking for a user interface for {{es}} and your data, head on over to {{kib}}! Not only are there amazing visualization and index management tools, {{kib}} includes realistic sample data sets to play with so that you can get to know what you *could* do with your data.
::::
