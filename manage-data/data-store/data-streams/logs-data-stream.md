...
You can enable logsdb on existing data streams as needed, by editing the relevant [index templates](#logsdb-index-template) or by using [@custom component templates](#logsdb-component-template). 
...
2. On the **Index Templates** tab, click **Create template** to create a new template, or click the name of an existing template to edit it. 
    ...
    :::{tip}
    If the existing template is labeled **Managed**, refer to [](logs-data-stream-managed.md).
    :::
...
### Set logsdb mode in a component template [logsdb-component-template]

To enable logsdb mode for integrations and other data streams that are created automatically, create a `@custom` template for each relevant [component template](/manage-data/data-store/index-basics.md#index-management-manage-component-templates). For details, refer to [](/manage-data/data-store/data-streams/logs-data-stream-managed.md).
...
- [](/manage-data/data-store/data-streams/logs-data-stream-managed.md)
