...
:::{note}
If you are using {{serverless-full}}, use [Managed Inputs](opentelemetry://reference/motlp/prometheus-remote-write.md) to send Prometheus metrics instead. Managed Inputs is the recommended ingestion path for {{ecloud}} deployments and provides durable buffering, unified authentication, and back-pressure handling.
:::
