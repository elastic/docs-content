...
* {applies_to}`stack: preview` {applies_to}`serverless: preview` To modify the data retention value, select an index, open the **Manage**  menu, and click **Edit data retention**.
