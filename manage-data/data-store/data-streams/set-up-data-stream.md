...
For {{fleet}} and {{agent}}, check out this [data streams documentation](docs-content://docs/reference/ingestion-tools/fleet/data-streams.md). For {{ls}}, check out the [data streams settings](logstash://docs/reference/ingestion-tools/logstash/plugins-outputs-elasticsearch.md#plugins-outputs-elasticsearch-data_stream) for the `elasticsearch output` plugin.
...
* A [`date`](elasticsearch://docs/reference/elasticsearch/mapping-reference/date.md) or [`date_nanos`](elasticsearch://docs/reference/elasticsearch/mapping-reference/date_nanos.md) mapping for the `@timestamp` field. If you don’t specify a mapping, {{es}} maps `@timestamp` as a `date` field with default options.
...
* One or more index patterns that match the data stream’s name. We recommend using our [data stream naming scheme](docs-content://docs/reference/ingestion-tools/fleet/data-streams.md#data-streams-naming-scheme).
