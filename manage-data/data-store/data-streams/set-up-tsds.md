...
* One or more index patterns that match the TSDS’s name. We recommend using our [data stream naming scheme](docs-content://docs/reference/ingestion-tools/fleet/data-streams.md#data-streams-naming-scheme).
* Enable data streams.
* Specify a mapping that defines your dimensions and metrics:

    * One or more [dimension fields](time-series-data-stream-tsds.md#time-series-dimension) with a `time_series_dimension` value of `true`. Alternatively, one or more [pass-through](elasticsearch://docs/reference/elasticsearch/mapping-reference/passthrough.md#passthrough-dimensions) fields configured as dimension containers, provided that they will contain at least one sub-field (mapped statically or dynamically).
...
* Define index settings:
    ...
    * Optional: Other index settings, such as [`index.number_of_replicas`](elasticsearch://docs/reference/elasticsearch/index-settings/index-modules.md#dynamic-index-number-of-replicas), for your TSDS’s backing indices.
