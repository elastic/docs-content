...
This is a simplified example that allows you to see quickly how [downsampling](../index-types/downsampling-time-series-data-stream.md) works as part of an ILM policy to reduce the storage size of a sampled set of metrics. The example uses typical Kubernetes cluster monitoring data. To test out downsampling with ILM, follow these steps:
...
Before running this example you may want to try the [Run downsampling manually](../index-types/run-downsampling-manually.md) example.
...
You can also try our [Run downsampling manually](../index-types/run-downsampling-manually.md) example to learn how downsampling can work outside of an ILM policy.
