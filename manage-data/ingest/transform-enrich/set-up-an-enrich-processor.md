...
::::{warning}
Enrich indices should only be used by the [enrich processor](elasticsearch://reference/enrich-processor/enrich-processor.md) or the [{{esql}} `ENRICH` command](elasticsearch://reference/query-languages/esql/_snippets/commands/layout/enrich.md). Avoid using enrich indices for other purposes.
