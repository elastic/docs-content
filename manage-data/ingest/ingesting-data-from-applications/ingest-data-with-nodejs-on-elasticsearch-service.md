...
:   If your application connecting to {{ech}} runs under the Java security manager, you should at least disable the caching of positive hostname resolutions. To learn more, check the [Java API Client documentation](elasticsearch-java://docs/reference/elasticsearch/elasticsearch-client-java-api-client/_others.md).
