...
Ingest models
:   {{agent}} to {{es}} using {{ls}} for advanced use cases such as enrichment, [event splitting](/manage-data/ingest/transform-enrich/split-events-into-multiple-documents.md), buffering, network bridging, multiple endpoints
