...
The [{{ls}} geoip filter](logstash://docs/reference/ingestion-tools/logstash/plugins-filters-geoip.md) requires regular database updates to remain up-to-date with the latest information. If you are using the {{ls}} geoip filter plugin in an air-gapped environment, you can manage updates through a proxy, a custom endpoint, or manually. Check out [Manage your own database updates](logstash://docs/reference/ingestion-tools/logstash/plugins-filters-geoip.md#plugins-filters-geoip-manage_update) for more info.
