...
* [{{ls}} {{es}} output plugin](logstash://docs/reference/ingestion-tools/logstash/plugins-outputs-elasticsearch.md)
* [{{ls}} output plugins](logstash://docs/reference/ingestion-tools/logstash/output-plugins.md)
