...
* **Semantic retrieval results re-ranking**
    ...
    * Adds a refinement layer on top of hybrid retrieval with [reciprocal rank fusion (RRF)](elasticsearch://docs/reference/elasticsearch/rest-apis/reciprocal-rank-fusion.md).
