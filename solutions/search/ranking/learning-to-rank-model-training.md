...
::::{note}
This feature was introduced in version 8.12.0 and is only available to certain subscription levels. For more information, see [Elastic self-managed subscriptions]({{subscriptions}}).
::::
