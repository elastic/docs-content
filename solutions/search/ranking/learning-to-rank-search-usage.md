...
Once your LTR model is trained and deployed in {{es}}, it can be used as a [rescorer](elasticsearch://docs/reference/elasticsearch/rest-apis/filter-search-results.md#rescore) in the [search API](../querying-for-search.md):
