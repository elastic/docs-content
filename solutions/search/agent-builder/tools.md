...
- **[Index search tools](../../search/agent-builder/tools/index-search-tools.md)**: Define tools that are scoped to a specific index or pattern, allowing the LLM to decide how to query those indices based on the user's request.
- **[ES|QL tools](../../search/agent-builder/tools/esql-tools.md)**: Define tools with explicit {{esql}} queries for precise, pre-defined data retrieval operations.
...
4. Fill in the required fields:
   ...
   - **Tool type**: Choose either **[{{esql}}](../../search/agent-builder/tools/esql-tools.md)** or **[Index search](../../search/agent-builder/tools/index-search-tools.md).**
