...
2. Ingest your data. Elasticsearch provides several methods for ingesting data:
    ...
    * [Connector clients](elasticsearch://docs/reference/ingestion-tools/search-connectors/index.md)
    * [File Uploader](/manage-data/ingest/upload-data-files.md)
    * [{{beats}}](beats://docs/reference/ingestion-tools/index.md)
    * [{{ls}}](logstash://docs/reference/ingestion-tools/logstash/index.md)
