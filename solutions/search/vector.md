...
- {applies_to}`stack: preview 9.3, ga 9.4` [GPU accelerated vector indexing](vector/gpu-vector-indexing.md): Speed up HNSW index construction on nodes with compatible NVIDIA GPUs.
