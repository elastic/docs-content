...
* [`script_score` query](elasticsearch://docs/reference/query-languages/query-dsl-script-score-query.md)
* [`rank_feature` query](elasticsearch://docs/reference/query-languages/query-dsl-rank-feature-query.md)
...
With the [`script_score` query](elasticsearch://docs/reference/query-languages/query-dsl-script-score-query.md) the query would look like this:
...
1. `pagerank` must be mapped as a [Numeric](elasticsearch://docs/reference/elasticsearch/mapping-reference/number.md)


while with the [`rank_feature` query](elasticsearch://docs/reference/query-languages/query-dsl-rank-feature-query.md) it would look like below:
