...
Searching with the `query_string` and/or `default_field` parameters will perform a [`query_string`](elasticsearch://docs/reference/query-languages/query-dsl-query-string-query.md) query.
...
* [`boost`](elasticsearch://docs/reference/query-languages/query-dsl-query-string-query.md#_boosting) fields to boost individual text search fields
