...
This tutorial introduced the basics of creating indices, adding data and performing basic searches {{es}}. Following resources will help you understand concepts better and dive into other query languages for searching data:
