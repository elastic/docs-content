...
::::{tip}
Try our hands-on [quickstart guides](/solutions/elasticsearch-solution-project/get-started/quickstarts.md) to get started, or check out our [Python notebooks](https://github.com/elastic/elasticsearch-labs/tree/main/notebooks#readme).
::::
