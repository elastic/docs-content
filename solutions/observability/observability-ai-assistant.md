...
* A self-deployed connector service if [search connectors](elasticsearch://docs/reference/ingestion-tools/search-connectors/self-managed-connectors.md) are used to populate external data into the knowledge base.
...
The infrastructure for deploying connectors must be [self-managed](elasticsearch://docs/reference/ingestion-tools/search-connectors/self-managed-connectors.md). 
