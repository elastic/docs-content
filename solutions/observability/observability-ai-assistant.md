...
When anonymization is enabled, every message in the request (system prompt, message content, tool call arguments/response) is run through an *anonymization pipeline* before it leaves Kibana:
