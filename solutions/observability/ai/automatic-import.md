...
description: Automatic Import helps you parse, ingest, and create ECS mappings for data without a prebuilt integration—see the full guide for Elastic Observability.
applies_to:
  stack: ga
  serverless:
    observability: ga
...
# Automatic import [observability-automatic-import]
