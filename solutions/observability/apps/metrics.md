...
APM agents automatically pick up basic host-level metrics, including system and process-level CPU and memory metrics. Agent specific metrics are also available, like [JVM metrics](apm-agent-java://docs/reference/ingestion-tools/apm-agent-java/metrics.md) in the Java Agent, and [Go runtime](apm-agent-go://docs/reference/ingestion-tools/apm-agent-go/metrics.md) metrics in the Go Agent.
...
* [Go](apm-agent-go://docs/reference/ingestion-tools/apm-agent-go/metrics.md)
* [Java](apm-agent-java://docs/reference/ingestion-tools/apm-agent-java/metrics.md)
* [Node.js](apm-agent-nodejs://docs/reference/ingestion-tools/apm-agent-nodejs/metrics.md)
* [Python](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/metrics.md)
* [Ruby](apm-agent-ruby://docs/reference/ingestion-tools/apm-agent-ruby/metrics.md)
