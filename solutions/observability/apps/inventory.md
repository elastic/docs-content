...
::::{note}
The new Inventory requires the Elastic Entity Model (EEM). To learn more, refer to [Elastic Entity Model](docs-content://docs/reference/observability/elastic-entity-model.md).
::::
