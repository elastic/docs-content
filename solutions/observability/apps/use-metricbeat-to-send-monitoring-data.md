...
1. Install {{metricbeat}} on the same server as APM Server. To learn how, see [Get started with {{metricbeat}}](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-installation-configuration.md). If you already have {{metricbeat}} installed on the server, skip this step.
...
6. [Start {{metricbeat}}](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-starting.md) to begin collecting monitoring data.
