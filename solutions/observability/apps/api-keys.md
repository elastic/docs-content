...
* **Android**: [`apiKey`](apm-agent-android://docs/reference/ingestion-tools/apm-agent-android/configuration.md)
* **Go agent**: [`ELASTIC_APM_API_KEY`](apm-agent-go://docs/reference/ingestion-tools/apm-agent-go/configuration.md#config-api-key)
* **.NET agent**: [`ApiKey`](apm-agent-dotnet://docs/reference/ingestion-tools/apm-agent-dotnet/config-reporter.md#config-api-key)
* **iOS**: [`withApiKey`](apm-agent-ios://docs/reference/ingestion-tools/apm-agent-swift/configuration.md#withApiKey)
* **Java agent**: [`api_key`](apm-agent-java://docs/reference/ingestion-tools/apm-agent-java/config-reporter.md#config-api-key)
* **Node.js agent**: [`apiKey`](apm-agent-nodejs://docs/reference/ingestion-tools/apm-agent-nodejs/configuration.md#api-key)
* **PHP agent**: [`api_key`](apm-agent-php://docs/reference/ingestion-tools/apm-agent-php/configuration-reference.md#config-api-key)
* **Python agent**: [`api_key`](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/configuration.md#config-api-key)
* **Ruby agent**: [`api_key`](apm-agent-ruby://docs/reference/ingestion-tools/apm-agent-ruby/configuration.md#config-api-key)
