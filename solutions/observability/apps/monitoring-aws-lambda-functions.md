...
* [Quick Start with APM on AWS Lambda - Node.js](apm-agent-nodejs://docs/reference/ingestion-tools/apm-agent-nodejs/lambda.md)
* [Quick Start with APM on AWS Lambda - Python](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/lambda-support.md)
* [Quick Start with APM on AWS Lambda - Java](apm-agent-java://docs/reference/ingestion-tools/apm-agent-java/aws-lambda.md)

Or, see the [architecture guide](apm-aws-lambda://docs/reference/ingestion-tools/apm-lambda/index.md) to learn more about how the extension works, performance impacts, and more.