...
The example below shows how to configure an `http` monitor, one of [three types of lightweight monitors](beats://docs/reference/ingestion-tools/beats-heartbeat/configuration-heartbeat-options.md#monitor-types).
...
Read more about configuration options in [Configure {{heartbeat}} monitors](beats://docs/reference/ingestion-tools/beats-heartbeat/configuration-heartbeat-options.md).
