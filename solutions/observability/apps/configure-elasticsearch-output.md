...
This documentation only applies to APM Server binary users. Fleet-managed users should see [Configure the {{es}} output](docs-content://docs/reference/ingestion-tools/fleet/elasticsearch-output.md).
