...
* [**APM Java agent →**](apm-agent-java://docs/reference/ingestion-tools/apm-agent-java/opentelemetry-bridge.md)
* [**APM .NET agent →**](apm-agent-dotnet://docs/reference/ingestion-tools/apm-agent-dotnet/opentelemetry-bridge.md)
* [**APM Node.js agent →**](apm-agent-nodejs://docs/reference/ingestion-tools/apm-agent-nodejs/opentelemetry-bridge.md)
* [**APM Python agent →**](apm-agent-python://docs/reference/ingestion-tools/apm-agent-python/opentelemetry-api-bridge.md)
