...
EDOT includes many types of LLM instrumentation. This [table](opentelemetry://reference/use-cases/llm/index.md#supported-technologies) lists the supported technologies.

### Getting started

Check [these instructions](opentelemetry://reference/use-cases/llm/index.md) on how to setup and collect OpenTelemetry data for your LLM applications.
