...
1. Manually [create a {{data-source}}](../../../explore-analyze/find-and-organize/data-views/create-data-view.md#settings-create-pattern) for the wired streams index pattern (`logs,logs.*`).
