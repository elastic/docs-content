...
* Ingest metrics using the [{{metricbeat}} Google Cloud Platform module](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-gcp.md) and view those metrics in {{kib}}.
* Export GCP audit logs through Pub/Sub topics.
* Ingest logs using the [{{filebeat}} Google Cloud module](beats://docs/reference/ingestion-tools/beats-filebeat/filebeat-module-gcp.md) and view those logs in {{kib}}.
...
To collect metrics from Google Cloud Platform, use the [Google Cloud Platform](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-gcp.md) module. This module periodically fetches monitoring metrics from Google Cloud Platform using [Stackdriver Monitoring API](https://cloud.google.com/monitoring/api/metrics_gcp) for Google Cloud Platform services.

::::{warning}
Extra GCP charges on Stackdriver Monitoring API requests may be generated by this module. Please see [rough estimation of the number of API calls](beats://docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-gcp.md#gcp-api-requests) for more details.
