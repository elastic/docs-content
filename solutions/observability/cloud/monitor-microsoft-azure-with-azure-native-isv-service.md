...
::::{note}
The {{ecloud}} Azure Native ISV Service lets you create and manage [{{ech}} deployments](/deploy-manage/deploy/elastic-cloud/cloud-hosted.md) directly in Azure through the Azure integrated marketplace. The service includes native capabilities for consolidating Azure logs and metrics in Elastic. For more information, refer to [Azure Native ISV Service](/deploy-manage/deploy/elastic-cloud/azure-native-isv-service.md).
