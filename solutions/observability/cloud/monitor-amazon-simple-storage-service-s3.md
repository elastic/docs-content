...
To collect S3 metrics, you typically need to install the Elastic [Amazon S3 integration](integration-docs://docs/reference/ingestion-tools/integrations/aws/s3.md) and deploy an {{agent}} locally or on an EC2 instance.
...
Here are the key metrics that you should watch, organized by category. For a full list of fields exported by the integration, refer to the [Amazon S3 integration](integration-docs://docs/reference/ingestion-tools/integrations/aws/s3.md) docs.
