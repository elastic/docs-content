...
The **Editor** role or higher is required to create anomaly detection rules. To learn more, refer to [](/deploy-manage/users-roles/cloud-organization/user-roles.md).
