...
To acknowledge an alert, go to the Alerts table, click the action menu ({icon}`boxes_vertical`) for the appropriate alert, then select **Acknowledge**. To revert the acknowledgement, open the same menu and select **Unacknowledge**.
