...
* [Metrics reference](docs-content://docs/reference/data-analysis/observability/metrics-reference-serverless.md): Learn about key metrics used for infrastructure monitoring.
* [Infrastructure app fields](docs-content://docs/reference/observability/serverless/infrastructure-app-fields.md): Learn about the fields required to display data in the Infrastructure UI.
