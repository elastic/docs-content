...
% TODO: restore anchor #ml-ad-cps-create when PR #7814 merges
2. {applies_to}`serverless: preview` Set **Project scope** to choose which linked projects the job analyzes. Refer to [Set project scope when creating a job](/explore-analyze/machine-learning/anomaly-detection/ml-ad-run-jobs.md).
