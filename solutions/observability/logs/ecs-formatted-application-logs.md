...
8. In the **Processors** text box, add the following YAML configuration to add processors that enhance your data. Refer to [processors](beats://docs/reference/ingestion-tools/beats-filebeat/filtering-enhancing-data.md) to learn more.
