...
- To run existing PromQL dashboards in Grafana against Elastic: [Use {{es}} as a Prometheus data source in Grafana](elasticsearch://reference/query-languages/promql/promql-grafana.md)
- To query metrics in Elastic using PromQL: [PromQL in {{es}}](elasticsearch://reference/query-languages/promql/functions.md)
