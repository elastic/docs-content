...
In this quickstart guide, you'll learn how to use the [Elastic Cloud Managed OTLP Endpoint](opentelemetry://reference/motlp.md) to send logs, metrics, and traces to Elastic.
