...
* For application instrumentation details, refer to [Instrumenting applications with Elastic OTel SDKs on Kubernetes](/solutions/observability/get-started/opentelemetry/use-cases/kubernetes/instrumenting-applications.md).
