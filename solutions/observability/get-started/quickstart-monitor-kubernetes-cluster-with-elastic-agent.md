...
:::{tip}
We recommend using the [{{agent}}](/solutions/observability/get-started/quickstart-unified-kubernetes-observability-with-opentelemetry.md) as the preferred way to collect Kubernetes logs, metrics, and application traces using OpenTelemetry.
:::
