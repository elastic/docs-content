...
:::{tip}
We recommend using the [{{edot}} Java SDK](elastic-otel-java://reference/edot-java/setup/index.md) as the preferred way to instrument your Java application. The Elastic OTel Java SDK provides OpenTelemetry-based instrumentation and can send telemetry data to Elastic.
:::
...
:::{note}
This tutorial uses the Elastic APM Java agent. We recommend using the [{{edot}} Java SDK](elastic-otel-java://reference/edot-java/setup/index.md) as the preferred way to instrument your Java application with OpenTelemetry-based instrumentation. Refer to the [Elastic OTel Java SDK setup guide](elastic-otel-java://reference/edot-java/setup/index.md) for instructions.
:::
