...
```html
<script src="https://example.com/path/to/elastic-apm-rum.umd.min-<version>.js" crossorigin></script>
<script>
  elasticApm.init({
...
<script>
  ;(function(d, s, c) {
    ...
    j.src = 'https://example.com/path/to/elastic-apm-rum.umd.min-<version>.js'
