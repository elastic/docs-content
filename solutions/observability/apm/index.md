...
Use [Get started with application traces and APM](/solutions/observability/apm/apm-server-fleet-managed.md) to quickly spin up an APM deployment. Want to host everything yourself instead? See [Get started](/solutions/observability/apm/get-started.md).