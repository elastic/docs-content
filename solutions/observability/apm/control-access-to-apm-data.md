...
Multiple APM integration instances is not required though. The simplest way to take advantage of this feature is by creating filtered aliases. Refer to [Separate staging and production data](#apm-spaces-example) for more information.
