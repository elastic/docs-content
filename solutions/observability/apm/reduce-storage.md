...
{{kib}}'s [Index management](/manage-data/data-store/index-management.md) UI allows you to manage your cluster’s indices, data streams, index templates, and much more.
