...
To learn more about security and data privacy, refer to [Elastic Managed LLMs](kibana://reference/kibana/connectors-kibana/elastic-managed-llm.md) which provides details on the models used by the connector.
