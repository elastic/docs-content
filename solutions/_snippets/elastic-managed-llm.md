[Elastic Managed LLMs](https://www.elastic.co/docs/reference/kibana/connectors-kibana/elastic-managed-llm) are preconfigured AI connectors available in {{kib}} projects with an Elastic [subscription](https://www.elastic.co/pricing) that includes AI features. {{serverless-short}} projects also need the appropriate feature tier They provide immediate access to generative AI features without requiring any setup or external model integration.  
