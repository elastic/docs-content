...
You can control access to Timeline by setting the [{{kib}} privileges](/solutions/security/get-started/security-kibana-privileges.md) for the **Timeline** feature under **Security**.
