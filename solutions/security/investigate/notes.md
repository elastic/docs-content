...
You can control access to notes by setting the [{{kib}} privileges](/solutions/security/get-started/security-kibana-privileges.md) for the **Notes** feature under **Security**.
