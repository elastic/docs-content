...
Investigate an indicator in [Timeline](timeline.md) to identify and predict related events in your environment. You can add an indicator to Timeline from the Indicators table or the Indicator details flyout.
...
2. Select one of the following:
    ...
    * **Add to new case**: Configure the case details. Refer to [Open a new case](open-manage-cases.md#cases-ui-open) to learn more about opening a new case.
...
Add indicator values to the [blocklist](../manage-elastic-defend/blocklist.md) to prevent selected applications from running on your hosts. You can use MD5, SHA-1, or SHA-256 hash values from `file` type indicators.
...
::::{note}
Refer to [Blocklist](../manage-elastic-defend/blocklist.md) for more information about blocklist entries.
::::
