...
1. Create a preconfigured email connector.
    ...
    ::::{note}
    At this time, email notifications support only [preconfigured email connectors](kibana://docs/reference/connectors-kibana/pre-configured-connectors.md), which are defined in the `kibana.yml` file.
    ::::
...
You can set file types and sizes by configuring your [{{kib}} case settings](kibana://docs/reference/configuration-reference/cases-settings.md).
