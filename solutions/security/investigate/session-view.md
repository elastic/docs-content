...
This page covers both turning on the process data Session View needs, which you do once in your {{elastic-defend}} integration policy, and using Session View to investigate. If that data is already collected, skip to [Open Session View](#open-session-view).
