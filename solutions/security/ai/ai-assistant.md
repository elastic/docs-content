...
This page covers both setting up AI Assistant and adjusting its settings once it's running. To change anonymization or Knowledge Base settings, skip to [Configure AI Assistant](#configure-ai-assistant).
