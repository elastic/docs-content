...
:::{note}
The agent has access to index names and field metadata from your cluster. This contextual information is used to improve ES|QL generation. This change may result in slightly longer response times. {applies_to}`stack: ga 9.1`
:::
