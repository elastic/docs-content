...
* The [**Attack Discovery Workflows**](/solutions/security/get-started/configure-advanced-settings.md#enable-attack-discovery-workflows) turned on if you want the settings flyout with skill, query, and workflow retrieval.
