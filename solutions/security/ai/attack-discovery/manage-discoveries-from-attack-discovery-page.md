...
On {{stack}} 9.5+ and {{serverless-short}}, manage discoveries from the [**Attacks** view](/solutions/security/ai/attack-discovery/manage-discoveries-from-attacks-page.md).
:::
