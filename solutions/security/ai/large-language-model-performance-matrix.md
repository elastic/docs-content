...
products:
  - id: security
  - id: cloud-serverless
description: Compare benchmark scores for large language models with Elastic Security across Agent Builder, Attack Discovery, and Automatic Migration workflows.
---

# Large language model performance matrix for {{elastic-sec}} [llm-performance-matrix]

This page summarizes internal test results comparing large language models (LLMs) across three {{elastic-sec}} workflows: [Agent Builder](/solutions/security/ai/agent-builder/agent-builder.md), [Attack Discovery](/solutions/security/ai/attack-discovery/index.md), and [Automatic Migration](/solutions/security/get-started/automatic-migration.md). To learn more about these use cases, refer to [AI-powered features](/explore-analyze/ai-features.md#security-features). To learn how these scores are produced, refer to [Benchmarking the Agentic SOC](https://www.elastic.co/security-labs/llm-benchmarking-agentic-soc) on Elastic Security Labs.

::::{important}
Higher scores indicate better performance, on a scale of 0 to 10. A score of 10 on a capability means the model met or exceeded all task-specific benchmarks for that capability.

**A model that scores 5 or below in an Agent Builder benchmark category, Attack Discovery, or Automatic Migration is not recommended for that task.**

Scores don't indicate whether a model or feature is available for your subscription, deployment, or version. Check the linked feature documentation and the supported models for your [LLM connector](/explore-analyze/ai-features/llm-guides/llm-connectors.md). Also consider requirements that the scores don't measure, such as latency, cost, and data residency.
::::
...
* **Overall Agent Builder Score** is the average of the seven Agent Builder [benchmark categories](#_agent_builder_sub_capabilities). It summarizes how well a model handles security tasks in Agent Builder.
* **Attack Discovery** measures coverage, accuracy, correlation quality, and actionability when the model groups alerts into attack narratives.
* **Automatic Migration** measures how faithfully the model translates a benchmark set of third-party SIEM rules into Elastic detection rules.
...
For a full walkthrough of the test data, known expected results, tool-call trace grading, and anonymized judging behind these scores, refer to [Benchmarking the Agentic SOC](https://www.elastic.co/security-labs/llm-benchmarking-agentic-soc) on Elastic Security Labs.

### What each Agent Builder benchmark category measures [_agent_builder_sub_capabilities]

* **Alert Analysis** — Triage and classify an alert, pull related alerts, and enrich the findings with threat intelligence.
...
* **Workflow Authoring** — Produce a valid, executable automation workflow, verified by creating, enabling, and running it.
* **Triggering Workflows** — Invoke the correct tool that runs a linked workflow, such as a hash lookup, an on-call schedule, or case creation.
...
| **OpenAI GPT-5.2** | 8.00 | 6.00 | 6.00 | 7.00 | 9.00 | 8.00 | 8.00 | **7.43** | 8.30 | 10.00 | **8.58** |
| **Anthropic Claude Opus 4.6** | 9.00 | 8.00 | 7.00 | 8.00 | 9.00 | 8.00 | 8.00 | **8.14** | 7.50 | 10.00 | **8.55** |
| **Google Gemini 2.5 Flash** | 5.00 | 6.00 | 6.00 | 5.00 | 6.00 | 7.00 | 6.00 | **5.86** | 9.50 | 9.81 | **8.39** |
| **Anthropic Claude Opus 4.5** | 9.00 | 7.00 | 7.00 | 8.00 | 9.00 | 8.00 | 8.00 | **8.00** | 9.20 | 7.30 | **8.17** |
| **Anthropic Claude Haiku 4.5** | 6.00 | 7.00 | 7.00 | 5.00 | 6.00 | 8.00 | 8.00 | **6.71** | 6.50 | 10.00 | **7.74** |
...
| **Google Gemini 3.5 Flash** | 8.00 | 8.00 | 7.00 | 8.00 | 9.00 | 8.00 | 8.00 | **8.00** | 5.60 | 6.60 | **6.73** |
| **Google Gemini 3.1 Pro (Preview)** | 8.00 | 7.00 | 7.00 | 8.00 | 9.00 | 8.00 | 8.00 | **7.86** | 4.20 | 8.10 | **6.72** |
| **OpenAI GPT-4.1** | 5.00 | 6.00 | 6.00 | 7.00 | 6.00 | 8.00 | 6.00 | **6.29** | 3.60 | 9.60 | **6.50** |
| **OpenAI GPT-5.4** | 7.00 | 7.00 | 8.00 | 8.00 | 9.00 | 8.00 | 8.00 | **7.86** | 5.30 | 5.90 | **6.35** |
| **OpenAI GPT-5.4 Nano** | 5.00 | 3.00 | 5.00 | 7.00 | 5.00 | 8.00 | 6.00 | **5.57** | 1.00 | 9.90 | **5.49** |
...
| **Gemma 4 31B IT** | 6.00 | 7.00 | 6.00 | 7.00 | 8.00 | 8.00 | 7.00 | **7.00** | 2.80 | 7.50 | **5.77** |
| **DeepSeek V4 Pro** | 5.00 | 6.00 | 0.00 | 6.00 | 9.00 | 8.00 | 7.00 | **5.86** | 8.30 | 3.10 | **5.75** |
