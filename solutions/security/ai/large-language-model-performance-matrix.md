...
For a full walkthrough of the evaluation framework behind these scores — the synthetic intrusion, deterministic ground truth, trace-level grading, and blind judging — see [Benchmarking the Agentic SOC](https://www.elastic.co/security-labs/llm-benchmarking-agentic-soc) on Elastic Security Labs.
