...
::::{important}
Indices added to Knowledge Base must have at least one field mapped as [semantic text](elasticsearch://docs/reference/elasticsearch/mapping-reference/semantic-text.md).
::::
