...
Each watchlist has a configurable risk weighting that influences the risk scores of its members. When an entity belongs to a watchlist, the risk scoring engine applies the watchlist's risk weighting — either increasing or decreasing the alert-based risk score depending on the configured weight.
