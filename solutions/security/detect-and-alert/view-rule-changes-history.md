...
Rule changes history is turned on by default. If you want to turn it off — for example, to avoid that overhead — disable the `securitySolution:enableRuleChangesHistory` [advanced setting](kibana://reference/advanced-settings.md#kibana-siem-settings).
