...
products:
  - id: security
  - id: cloud-serverless
description: 'Investigation guide for the "M365 Exchange Federated Domain Created or Modified" prebuilt detection rule.'
---
...
### Investigating M365 Exchange Federated Domain Created or Modified
