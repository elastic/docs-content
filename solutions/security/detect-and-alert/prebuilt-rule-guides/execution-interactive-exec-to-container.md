...
products:
  - id: security
  - id: cloud-serverless
description: Investigation guide for the "Interactive Exec Into Container Detected via Defend for Containers" prebuilt detection rule.
---
...
### Investigating Interactive Exec Into Container Detected via Defend for Containers
