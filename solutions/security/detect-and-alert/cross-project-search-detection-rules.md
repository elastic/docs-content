...
The rule writes every alert it generates to the origin project, no matter which project the matching events came from. The origin project's **Alerts** page shows those alerts. It doesn't show alerts generated by rules defined in other projects.
