...
For example, to prevent the [Unusual Process Execution Path - Alternate Data Stream](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/unusual-process-execution-path-alternate-data-stream.md) rule from producing alerts for an in-house application named `myautomatedbuild`:
...
* [Suspicious MS Office Child Process](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/suspicious-ms-office-child-process.md)
* [Suspicious MS Outlook Child Process](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/suspicious-ms-outlook-child-process.md)
* [System Shells via Services](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/system-shells-via-services.md)
* [Unusual Parent-Child Relationship](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/unusual-parent-child-relationship.md)
* [Windows Script Executing PowerShell](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/windows-script-executing-powershell.md)
...
* [RDP (Remote Desktop Protocol) from the Internet](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/rdp-remote-desktop-protocol-from-the-internet.md)
