...
* Click the history icon to display a list of previously visited places. The list will show any rules, alerts, users, or hosts who's details you viewed. Click their entry to quickly access their details flyout.
