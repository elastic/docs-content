...
| [v17.1](https://attack.mitre.org/resources/updates/updates-april-2025/) | • {applies_to}`stack: ga 9.0.7` <br> • {applies_to}`stack: ga 9.1.4` <br> • {applies_to}`stack: ga 9.2.0` <br> • {{serverless-short}} |
