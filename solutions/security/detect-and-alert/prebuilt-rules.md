...
**[Handle deprecated prebuilt rules](/solutions/security/detect-and-alert/manage-detection-rules.md#deprecated-prebuilt-rules)** {applies_to}`stack: ga 9.4+` {applies_to}`serverless: ga`
