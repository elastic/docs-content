...
::::{tip}
For [threshold rule](/solutions/security/detect-and-alert/using-the-rule-builder.md) alerts, Timeline shows all matching events, not just those that crossed the threshold.
::::
