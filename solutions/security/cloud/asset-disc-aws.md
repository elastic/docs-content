...
7. Next, you’ll need to authenticate to AWS. Two methods are available:
    ...
    2. Option 2: Temporary keys. To authenticate using temporary keys, refer to the instructions for [temporary keys](/solutions/security/cloud/asset-disc-aws.md#cad-aws-temp-credentials).
...
1. In the **Add Cloud Asset Discovery integration** menu, under **Setup Access**, select **CloudFormation**.
