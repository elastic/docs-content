...
Quarantined files are handled automatically when **Prevent** is active. To restore or retrieve one, refer to [Manage quarantined files](/solutions/security/manage-elastic-defend/manage-quarantined-files.md).
