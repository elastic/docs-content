...
* **Actions**: Select the context menu (**…​**) to do the following:
    ...
    * **Reassign agent policy**: Change the [agent policy](docs-content://docs/reference/ingestion-tools/fleet/agent-policy.md#apply-a-policy) assigned to the host in {{fleet}}.
