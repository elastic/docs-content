...
* The {{agent}} to send data from Splunk to {{elastic-sec}}. See [Get started with data from Splunk](/observability/get-started/other-tutorials/add-data-from-splunk.md).
