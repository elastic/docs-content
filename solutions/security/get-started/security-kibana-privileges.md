...
| **Automatic Migration** | Access [Automatic Migration](/solutions/security/get-started/automatic-migration.md). <br> {applies_to}`stack: ga 9.0-9.2` Before 9.2.4, this privilege is called **SIEM migrations**. |
:::
