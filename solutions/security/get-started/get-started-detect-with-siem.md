...
* Learn how to reduce your mean time to respond with [Attack Discovery](/solutions/security/ai/attack-discovery/attack-discovery.md), an AI threat hunting feature that leverages large language models (LLMs) to analyze alerts in your environment, identify threats, and show how they correspond to the MITRE ATT&CK matrix.
