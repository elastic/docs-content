...
::::{note}
The `cases:maxOpenCasesPerRuleRun` setting does not apply to [Attack Discovery](/solutions/security/ai/attack-discovery/attack-discovery.md). Attack Discovery continues to use its own case-creation limit (20).
::::
