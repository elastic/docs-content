...
* **Read** for the **Security** privilege in the [space](/deploy-manage/manage-spaces.md). This grants read access to the {{elastic-sec}} features that don't have a privilege of their own. Other features, such as cases, have their own privileges. For the full list, refer to [Security {{kib}} privileges](/solutions/security/get-started/security-kibana-privileges.md).
