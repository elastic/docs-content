...
* [**External Alerts**](asciidocalypse://docs/security-docs/docs/reference/security/prebuilt-rules/external-alerts.md): Automatically creates an alert for all incoming third-party system alerts (for example, Suricata alerts).
