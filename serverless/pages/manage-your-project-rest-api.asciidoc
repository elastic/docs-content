...
You can manage serverless projects using the {{cloud-serverless-apis}}[Elastic Cloud Serverless REST API]. This API allows you to create, update, and delete projects, as well as manage project features and usage.
...
For details, check the {{cloud-serverless-apis}}[API reference] or download the {{cloud-serverless-apis}}.yaml[OpenAPI Specification].
