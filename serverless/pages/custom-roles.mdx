...
By default, custom roles grant the same access as the `Viewer` instance access role with regards to ((ecloud)) privileges.
...
{/* TBD: This additional level of control is a subscription feature. */}
