...
+
When running copied requests from an external environment, you'll need to add {{kib-serverless-apis}}authentication[authentication information] to the request.
