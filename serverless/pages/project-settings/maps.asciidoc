...
[discrete]
[[-serverless-maps-build-maps-with-multiple-layers-and-indices]]
== Build maps with multiple layers and indices
...
[discrete]
[[-serverless-maps-animate-spatial-temporal-data]]
== Animate spatial temporal data
...
[discrete]
[[-serverless-maps-upload-geojson-files-and-shapefiles]]
== Upload GeoJSON files and shapefiles
...
[discrete]
[[-serverless-maps-embed-your-map-in-dashboards]]
== Embed your map in dashboards
...
Add your map to a https://www.elastic.co/docs/current/serverless/elasticsearch/explore-your-data-dashboards[dashboard] and view your geospatial data alongside bar charts, pie charts, tag clouds, and more.
...
[discrete]
[[-serverless-maps-focus-on-only-the-data-thats-important-to-you]]
== Focus on only the data that's important to you
