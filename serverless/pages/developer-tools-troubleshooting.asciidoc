...
Use the {{es-serverless-apis}}operation/operation-indices-exists[**Exists API**] to check whether
...
Use the {{es-serverless-apis}}operation/operation-indices-get[**Get index API**]
...
Use the {{es-serverless-apis}}operation/operation-count-1[**Count API**]
...
Use the {{es-serverless-apis}}operation/operation-field-caps[**Field capabilities API**]
...
To retrieve the mapping, use the {{es-serverless-apis}}operation/operation-indices-get-mapping[**Get mapping API**]:
...
configured.
You can use the {{es-serverless-apis}}operation/operation-indices-analyze[**Analyze API**]
...
To change the mapping of an existing field use the {{es-serverless-apis}}operation/operation-indices-put-mapping-1[**Update mapping API**].
...
The {{es-serverless-apis}}operation/operation-indices-validate-query[**Validate API**]
...
Use the {{es-serverless-apis}}operation/operation-indices-get-settings[**Get index settings API**]
...
{{es-serverless-apis}}operation/operation-indices-put-settings[**Update index settings API**].
