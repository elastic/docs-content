...
| Build embedding-driven workloads such as semantic search, RAG, and AI-powered retrieval | [{{es}} {{vectordb}}](/solutions/vector-database.md) {applies_to}`serverless:`<br>• [Get started](/solutions/vector-database/get-started.md) {applies_to}`serverless:` | Developers, architects, data engineers |
